...
<html lang="en-IN">
  <head>
    ...
    <link href="https://embracelives.com/autism/autism-in-girls" rel="canonical" />
    
    <!-- Open Graph -->
    <meta content="website" property="og:type" />
    <meta content="https://embracelives.com/autism/autism-in-girls" property="og:url" />
...
<title>Autism in Girls: Under-diagnosed Traits & Masking | eMbrace Lives</title>
  ...
  <script type="application/ld+json">
  {
    ...
    "@graph": [
      ...
      {
        "@type": "BreadcrumbList",
        "@id": "https://embracelives.com/autism/autism-in-girls#breadcrumb",
        "itemListElement": [
          {
            "@type": "ListItem",
            "position": 1,
          ...
          },
          {
            "@type": "ListItem",
            "position": 3,
            "name": "Autism in Girls & Women"
          }
        ]
      },
      {
        "@type": "MedicalWebPage",
        "@id": "https://embracelives.com/autism/autism-in-girls#webpage",
        "url": "https://embracelives.com/autism/autism-in-girls",
      ...
      {
        "@type": "FAQPage",
        "@id": "https://embracelives.com/autism/autism-in-girls#faq",
        "url": "https://embracelives.com/autism/autism-in-girls",
        "name": "Autism in Girls: Under-diagnosed Traits & Masking | eMbrace Lives — Frequently Asked Questions",
        "isPartOf": {
          "@id": "https://embracelives.com/autism/autism-in-girls#webpage"
        },
        "inLanguage": "en-IN",
        "mainEntity": [
          {
            "@type": "Question",
            "name": "Why is autism diagnosed less frequently in girls?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Historically, diagnostic criteria were based on male behavior. Girls also tend to have stronger social imitation habits and special interests that match social norms, which helps them blend in more easily."
            }
          },
          {
            "@type": "Question",
            "name": "What is the long-term impact of masking in girls?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Constant masking requires massive cognitive effort. Over time, it can lead to anxiety, depression, low self-esteem, loss of personal identity, and eventual autistic burnout."
            }
          }
        ]
      }
  ...
  <div class="mb-6">
    ...
    <ul class="space-y-1 ml-2">
      <li><a class="block px-3 py-1.5 text-xs rounded-xl transition-all duration-200 bg-[#234394] text-white font-semibold" href="/autism/autism-in-girls.php">Autism in Girls & Women</a></li>
  ...
  <details class="group">
    ...
    <div class="mt-4 pt-3 border-t border-gray-200 max-h-[60vh] overflow-y-auto">
      ...
      <div class="mb-4">
        ...
        <ul class="space-y-1 ml-1">
          <li><a class="block py-1 text-xs text-[#234394] font-bold" href="/autism/autism-in-girls.php">Autism in Girls & Women</a></li>
