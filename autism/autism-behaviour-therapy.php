...
<html lang="en-IN">
  <head>
    ...
    <link href="https://embracelives.com/autism/autism-behaviour-therapy" rel="canonical" />
    
    <!-- Open Graph -->
    <meta content="website" property="og:type" />
    <meta content="https://embracelives.com/autism/autism-behaviour-therapy" property="og:url" />
...
<title>Autism Behaviour Support & Regulation | eMbrace Lives</title>
  ...
  <script type="application/ld+json">
  {
    ...
    "@graph": [
      ...
      {
        "@type": "BreadcrumbList",
        "@id": "https://embracelives.com/autism/autism-behaviour-therapy#breadcrumb",
        "itemListElement": [
          {
            "@type": "ListItem",
            "position": 1,
          ...
          },
          {
            "@type": "ListItem",
            "position": 3,
            "name": "Positive Behaviour Support & Regulation"
          }
        ]
      },
      {
        "@type": "MedicalWebPage",
        "@id": "https://embracelives.com/autism/autism-behaviour-therapy#webpage",
        "url": "https://embracelives.com/autism/autism-behaviour-therapy",
      ...
      {
        "@type": "FAQPage",
        "@id": "https://embracelives.com/autism/autism-behaviour-therapy#faq",
        "url": "https://embracelives.com/autism/autism-behaviour-therapy",
        "name": "Autism Behaviour Support & Regulation | eMbrace Lives — Frequently Asked Questions",
        "isPartOf": {
          "@id": "https://embracelives.com/autism/autism-behaviour-therapy#webpage"
        },
        "inLanguage": "en-IN",
        "mainEntity": [
          {
            "@type": "Question",
            "name": "What is the difference between compliance therapy and affirming support?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Compliance therapy focuses on changing behaviors to match social norms, often suppressing natural self-regulation. Affirming support seeks to understand the root cause of distress, adapt the environment, and teach coping skills."
            }
          },
          {
            "@type": "Question",
            "name": "How do you help manage intense meltdowns?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "We work to identify the triggers of sensory or emotional overload. We then create plans focused on safety, lowering sensory input, using co-regulation strategies, and providing a quiet space to recover."
            }
          }
        ]
      }
  ...
  <div class="mb-6">
    ...
    <ul class="space-y-1 ml-2">
      ...
      <li><a class="block px-3 py-1.5 text-xs rounded-xl transition-all duration-200 bg-[#234394] text-white font-semibold" href="/autism/autism-behaviour-therapy.php">Positive Behaviour Support & Regulation</a></li>
    ...
    <div class="mt-4 pt-3 border-t border-gray-200 max-h-[60vh] overflow-y-auto">
      ...
      <div class="mb-4">
        ...
        <ul class="space-y-1 ml-1">
          ...
          <li><a class="block py-1 text-xs text-[#234394] font-bold" href="/autism/autism-behaviour-therapy.php">Positive Behaviour Support & Regulation</a></li>
