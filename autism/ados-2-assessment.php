...
<html lang="en-IN">
  <head>
    ...
    <link href="https://embracelives.com/autism/ados-2-assessment" rel="canonical" />
    
    <!-- Open Graph -->
    <meta content="website" property="og:type" />
    <meta content="https://embracelives.com/autism/ados-2-assessment" property="og:url" />
...
<title>ADOS-2 Assessment: Gold-Standard Testing | eMbrace Lives</title>
  ...
  <script type="application/ld+json">
  {
    ...
    "@graph": [
      ...
      {
        "@type": "BreadcrumbList",
        "@id": "https://embracelives.com/autism/ados-2-assessment#breadcrumb",
        "itemListElement": [
          {
            "@type": "ListItem",
            "position": 1,
          ...
          },
          {
            "@type": "ListItem",
            "position": 3,
            "name": "ADOS-2 Diagnostic Assessment"
          }
        ]
      },
      {
        "@type": "MedicalWebPage",
        "@id": "https://embracelives.com/autism/ados-2-assessment#webpage",
        "url": "https://embracelives.com/autism/ados-2-assessment",
      ...
      {
        "@type": "FAQPage",
        "@id": "https://embracelives.com/autism/ados-2-assessment#faq",
        "url": "https://embracelives.com/autism/ados-2-assessment",
        "name": "ADOS-2 Assessment: Gold-Standard Testing | eMbrace Lives — Frequently Asked Questions",
        "isPartOf": {
          "@id": "https://embracelives.com/autism/ados-2-assessment#webpage"
        },
        "inLanguage": "en-IN",
        "mainEntity": [
          {
            "@type": "Question",
            "name": "Can adults take the ADOS-2 assessment?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Yes. Module 4 of the ADOS-2 is specifically designed for verbally fluent teenagers and adults, focusing on conversations about relationships, work, and daily life."
            }
          },
          {
            "@type": "Question",
            "name": "How long does an ADOS-2 session last?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "The direct observation session usually takes 40 to 60 minutes. The scoring and report writing are completed by the clinician afterward."
            }
          }
        ]
      }
  ...
  <div class="mb-6">
    ...
    <ul class="space-y-1 ml-2">
      ...
      <li><a class="block px-3 py-1.5 text-xs rounded-xl transition-all duration-200 bg-[#234394] text-white font-semibold" href="/autism/ados-2-assessment.php">ADOS-2 Diagnostic Assessment</a></li>
    ...
    <div class="mt-4 pt-3 border-t border-gray-200 max-h-[60vh] overflow-y-auto">
      ...
      <div class="mb-4">
        ...
        <ul class="space-y-1 ml-1">
          ...
          <li><a class="block py-1 text-xs text-[#234394] font-bold" href="/autism/ados-2-assessment.php">ADOS-2 Diagnostic Assessment</a></li>
