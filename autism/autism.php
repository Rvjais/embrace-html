...
<html lang="en-IN">
  <head>
    ...
    <link href="https://embracelives.com/autism/autism" rel="canonical" />
    
    <!-- Open Graph -->
    <meta content="website" property="og:type" />
    <meta content="https://embracelives.com/autism/autism" property="og:url" />
...
<title>Autism Spectrum Support & Information Hub | eMbrace Lives Delhi</title>
  ...
  <script type="application/ld+json">
  {
    ...
    "@graph": [
      ...
      {
        "@type": "BreadcrumbList",
        "@id": "https://embracelives.com/autism/autism#breadcrumb",
        "itemListElement": [
          {
            "@type": "ListItem",
            "position": 1,
          ...
          },
          {
            "@type": "ListItem",
            "position": 3,
            "name": "Autism Support & Resource Hub"
          }
        ]
      },
      {
        "@type": "MedicalWebPage",
        "@id": "https://embracelives.com/autism/autism#webpage",
        "url": "https://embracelives.com/autism/autism",
      ...
      {
        "@type": "FAQPage",
        "@id": "https://embracelives.com/autism/autism#faq",
        "url": "https://embracelives.com/autism/autism",
        "name": "Autism Spectrum Support & Information Hub | eMbrace Lives Delhi — Frequently Asked Questions",
        "isPartOf": {
          "@id": "https://embracelives.com/autism/autism#webpage"
        },
        "inLanguage": "en-IN",
        "mainEntity": [
          {
            "@type": "Question",
            "name": "What is eMbrace's philosophy on autism support?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "At eMbrace, we practice neurodiversity-affirming care. Our goal is not to eliminate autistic traits or force conformity, but to foster self-advocacy, reduce distress, build communication, and provide sensory-friendly tools for daily life."
            }
          },
          {
            "@type": "Question",
            "name": "What diagnostic tools does eMbrace use for autism?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "We use the gold-standard ADOS-2 (Autism Diagnostic Observation Schedule), CARS-2 (Childhood Autism Rating Scale), and the Mullen Scales of Early Learning, combined with structured parental developmental history interviews."
            }
          },
          {
            "@type": "Question",
            "name": "Are your services available online and in-person?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Yes, we offer comprehensive in-person evaluations and therapy sessions at our Delhi clinic, as well as online therapy and coaching sessions for families residing outside the capital."
            }
          }
        ]
      }
  ...
  <div class="mb-6">
    ...
    <ul class="space-y-1 ml-2">
      <li><a class="block px-3 py-1.5 text-xs rounded-xl transition-all duration-200 bg-[#234394] text-white font-semibold" href="/autism/autism.php">Autism Support & Resource Hub</a></li>
  ...
  <div class="mb-6">
    ...
    <ul class="space-y-1 ml-2">
      ...
      <li><a class="block px-3 py-1.5 text-xs rounded-xl transition-all duration-200 text-gray-600 hover:text-[#234394] hover:bg-white" href="/autism/autism-therapy.php">Autism Therapy Services</a></li>
    ...
    <div class="mt-4 pt-3 border-t border-gray-200 max-h-[60vh] overflow-y-auto">
      <div class="mb-4">
        ...
        <ul class="space-y-1 ml-1">
          <li><a class="block py-1 text-xs text-[#234394] font-bold" href="/autism/autism.php">Autism Support & Resource Hub</a></li>
      ...
      <div class="mb-4">
        ...
        <ul class="space-y-1 ml-1">
          ...
          <li><a class="block py-1 text-xs text-gray-600" href="/autism/autism-therapy.php">Autism Therapy Services</a></li>
      ...
      <div class="mb-4">
        ...
        <ul class="space-y-1 ml-1">
          ...
          <div class="flex-grow max-w-4xl article-content">
            ...
            <p class="text-base text-gray-700 leading-relaxed mb-8">Families reach us from right across the capital region. You can begin with an <a class="text-[#234394] font-semibold hover:underline" href="/locations/autism-assessment-in-delhi">autism assessment in Delhi</a> or <a class="text-[#234394] font-semibold hover:underline" href="/locations/autism-assessment-in-south-delhi">South Delhi</a>, then continue into <a class="text-[#234394] font-semibold hover:underline" href="/locations/autism-therapy-in-saket">autism therapy in Saket</a>, <a class="text-[#234394] font-semibold hover:underline" href="/locations/autism-therapy-in-gurgaon">Gurgaon</a> or <a class="text-[#234394] font-semibold hover:underline" href="/locations/autism-therapy-in-noida">Noida</a> — the same multidisciplinary pathway runs at <a class="text-[#234394] font-semibold hover:underline" href="/locations">all eMbrace locations</a>.</p>
            <!-- LOCATION-INTEXT:END -->
