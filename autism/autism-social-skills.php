...
<html lang="en-IN">
  <head>
    ...
    <link href="https://embracelives.com/autism/autism-social-skills" rel="canonical" />
    
    <!-- Open Graph -->
    <meta content="website" property="og:type" />
    <meta content="https://embracelives.com/autism/autism-social-skills" property="og:url" />
...
<title>Autism Social Skills & Peer Connection Groups | eMbrace Lives</title>
  ...
  <script type="application/ld+json">
  {
    ...
    "@graph": [
      ...
      {
        "@type": "BreadcrumbList",
        "@id": "https://embracelives.com/autism/autism-social-skills#breadcrumb",
        "itemListElement": [
          {
            "@type": "ListItem",
            "position": 1,
          ...
          },
          {
            "@type": "ListItem",
            "position": 3,
            "name": "Affirming Peer Connection Groups"
          }
        ]
      },
      {
        "@type": "MedicalWebPage",
        "@id": "https://embracelives.com/autism/autism-social-skills#webpage",
        "url": "https://embracelives.com/autism/autism-social-skills",
      ...
      {
        "@type": "FAQPage",
        "@id": "https://embracelives.com/autism/autism-social-skills#faq",
        "url": "https://embracelives.com/autism/autism-social-skills",
        "name": "Autism Social Skills & Peer Connection Groups | eMbrace Lives — Frequently Asked Questions",
        "isPartOf": {
          "@id": "https://embracelives.com/autism/autism-social-skills#webpage"
        },
        "inLanguage": "en-IN",
        "mainEntity": [
          {
            "@type": "Question",
            "name": "What is the group size and age range?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Groups typically consist of 3 to 5 children of similar ages (e.g., ages 6-8, 9-11, or teens). This ensures a supportive environment with ample individual attention."
            }
          },
          {
            "@type": "Question",
            "name": "Do you teach eye contact in social groups?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "No. Forcing eye contact can cause discomfort and distract from listening. We validate looking away while listening as a healthy way to process information."
            }
          }
        ]
      }
  ...
  <div class="mb-6">
    ...
    <ul class="space-y-1 ml-2">
      ...
      <li><a class="block px-3 py-1.5 text-xs rounded-xl transition-all duration-200 bg-[#234394] text-white font-semibold" href="/autism/autism-social-skills.php">Affirming Peer Connection Groups</a></li>
    ...
    <div class="mt-4 pt-3 border-t border-gray-200 max-h-[60vh] overflow-y-auto">
      ...
      <div class="mb-4">
        ...
        <ul class="space-y-1 ml-1">
          ...
          <li><a class="block py-1 text-xs text-[#234394] font-bold" href="/autism/autism-social-skills.php">Affirming Peer Connection Groups</a></li>
