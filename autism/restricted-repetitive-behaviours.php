...
<html lang="en-IN">
  <head>
    ...
    <link href="https://embracelives.com/autism/restricted-repetitive-behaviours" rel="canonical" />
    
    <!-- Open Graph -->
    <meta content="website" property="og:type" />
    <meta content="https://embracelives.com/autism/restricted-repetitive-behaviours" property="og:url" />
...
<title>Restricted & Repetitive Behaviours in Autism | eMbrace Lives</title>
  ...
  <script type="application/ld+json">
  {
    ...
    "@graph": [
      ...
      {
        "@type": "BreadcrumbList",
        "@id": "https://embracelives.com/autism/restricted-repetitive-behaviours#breadcrumb",
        "itemListElement": [
          {
            "@type": "ListItem",
            "position": 1,
          ...
          },
          {
            "@type": "ListItem",
            "position": 3,
            "name": "Routines, Stimming & Repetitive Behaviours"
          }
        ]
      },
      {
        "@type": "MedicalWebPage",
        "@id": "https://embracelives.com/autism/restricted-repetitive-behaviours#webpage",
        "url": "https://embracelives.com/autism/restricted-repetitive-behaviours",
      ...
      {
        "@type": "FAQPage",
        "@id": "https://embracelives.com/autism/restricted-repetitive-behaviours#faq",
        "url": "https://embracelives.com/autism/restricted-repetitive-behaviours",
        "name": "Restricted & Repetitive Behaviours in Autism | eMbrace Lives — Frequently Asked Questions",
        "isPartOf": {
          "@id": "https://embracelives.com/autism/restricted-repetitive-behaviours#webpage"
        },
        "inLanguage": "en-IN",
        "mainEntity": [
          {
            "@type": "Question",
            "name": "Should stimming be stopped?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "No, stimming should not be stopped. It is a healthy way to self-regulate. We only step in if a stim causes self-injury, in which case we work with occupational therapists to guide them toward a safer sensory alternative."
            }
          },
          {
            "@type": "Question",
            "name": "Why are routines so important for autistic individuals?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Predictability lowers the cognitive load required to process daily changes. When routines are consistent, it reduces anxiety and frees up energy to handle school, work, and social demands."
            }
          }
        ]
      }
  ...
  <div class="mb-6">
    ...
    <ul class="space-y-1 ml-2">
      ...
      <li><a class="block px-3 py-1.5 text-xs rounded-xl transition-all duration-200 bg-[#234394] text-white font-semibold" href="/autism/restricted-repetitive-behaviours.php">Routines, Stimming & Repetitive Behaviours</a></li>
    </ul>
  </div>
  <div class="mb-6">
    ...
    <div class="mt-4 pt-3 border-t border-gray-200 max-h-[60vh] overflow-y-auto">
      <div class="mb-4">
        ...
        <ul class="space-y-1 ml-1">
          ...
          <li><a class="block py-1 text-xs text-[#234394] font-bold" href="/autism/restricted-repetitive-behaviours.php">Routines, Stimming & Repetitive Behaviours</a></li>
        </ul>
      </div>
      <div class="mb-4">
