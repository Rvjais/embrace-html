...
<html lang="en-IN">
  <head>
    ...
    <link href="https://embracelives.com/autism/autism-and-feeding" rel="canonical" />
    
    <!-- Open Graph -->
    <meta content="website" property="og:type" />
    <meta content="https://embracelives.com/autism/autism-and-feeding" property="og:url" />
...
<title>Autism and Feeding: Selective Eating & Sensory Needs | eMbrace Lives</title>
  ...
  <script type="application/ld+json">
  {
    ...
    "@graph": [
      ...
      {
        "@type": "BreadcrumbList",
        "@id": "https://embracelives.com/autism/autism-and-feeding#breadcrumb",
        "itemListElement": [
          {
            "@type": "ListItem",
            "position": 1,
          ...
          },
          {
            "@type": "ListItem",
            "position": 3,
            "name": "Autism, Feeding & Selective Eating"
          }
        ]
      },
      {
        "@type": "MedicalWebPage",
        "@id": "https://embracelives.com/autism/autism-and-feeding#webpage",
        "url": "https://embracelives.com/autism/autism-and-feeding",
      ...
      {
        "@type": "FAQPage",
        "@id": "https://embracelives.com/autism/autism-and-feeding#faq",
        "url": "https://embracelives.com/autism/autism-and-feeding",
        "name": "Autism and Feeding: Selective Eating & Sensory Needs | eMbrace Lives — Frequently Asked Questions",
        "isPartOf": {
          "@id": "https://embracelives.com/autism/autism-and-feeding#webpage"
        },
        "inLanguage": "en-IN",
        "mainEntity": [
          {
            "@type": "Question",
            "name": "Why does pressure to eat make selective eating worse?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Pressuring a child activates their fight-or-flight response, which reduces appetite, increases food anxiety, and can lead to mealtime standoffs."
            }
          },
          {
            "@type": "Question",
            "name": "How can we introduce new foods at home?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Start by placing a tiny piece of the new food near the child's plate without requiring them to eat it. Let them explore its smell, texture, and look before trying a taste."
            }
          }
        ]
      }
  ...
  <div class="mb-6">
    ...
    <ul class="space-y-1 ml-2">
      ...
      <li><a class="block px-3 py-1.5 text-xs rounded-xl transition-all duration-200 bg-[#234394] text-white font-semibold" href="/autism/autism-and-feeding.php">Autism, Feeding & Selective Eating</a></li>
    ...
    <div class="mt-4 pt-3 border-t border-gray-200 max-h-[60vh] overflow-y-auto">
      ...
      <div class="mb-4">
        ...
        <ul class="space-y-1 ml-1">
          ...
          <li><a class="block py-1 text-xs text-[#234394] font-bold" href="/autism/autism-and-feeding.php">Autism, Feeding & Selective Eating</a></li>
