...
<html lang="en-IN">
  <head>
    ...
    <link href="https://embracelives.com/adolescents.php" rel="canonical" />
    <!-- Open Graph -->
    <meta content="website" property="og:type" />
    <meta content="https://embracelives.com/adolescents.html" property="og:url" />
    ...
    <div id="root">
      ...
      >
        ...
        <div class="md:justify-center w-full p-4 py-8 relative flex flex-col md:pt-0 md:p-12 gap-8 md:px-16">
          ...
          <h1 class="md:text-3xl text-lg font-bold text-center">Assessments</h1>
          <p class="font-medium text-sm md:text-base text-[var(--text-gray)] italic text-center">
      ...
      <div class="overflow-hidden flex flex-col items-center px-4 md:px-8 lg:px-16 xl:px-20 py-6 relative">
        <div class="md:min-h-screen flex flex-col items-center">
          <h1 class="text-xl md:text-3xl font-bold text-center">Therapy Services</h1>
          ...
          <div class="gap-8 flex flex-col pt-8 mb-4 w-full">
            <h1 class="text-xl md:text-3xl font-bold text-center">Psychiatric Support</h1>
            <p class="font-medium text-sm md:text-base text-[var(--text-gray)] italic text-center">
