    ...
    },
    {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "item": "https://embracelives.com/intellectual-disability/intellectual-disability-treatment"
        }
      ]
    },
    {
...
<div class="py-3 px-6 md:px-16 border-b border-gray-100 text-xs md:text-sm text-gray-500 breadcrumbs">
  <div class="max-w-7xl mx-auto flex items-center gap-2 flex-wrap">
      ...
      <a href="/intellectual-disability/intellectual-disability-treatment.php">Intellectual Disability</a><span class="text-gray-300">/</span>
...
<p>For the full clinical picture, including what the difficulty is, the signs worth acting on and how treatment is planned, read our <a href="/intellectual-disability/intellectual-disability-treatment.php" class="text-[#234394] font-semibold">Intellectual Disability Treatment guide</a>.</p>
