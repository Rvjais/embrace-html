...
<meta content="Child counselling in Greater Kailash for anxiety, anger, confidence and friendship difficulties, at our Malviya Nagar centre. Book a free intake call today." name="description"/>
<meta content="index, follow" name="robots"/>
<link href="https://embracelives.com/locations/child-counselling-in-greater-kailash" rel="canonical"/>
<meta content="website" property="og:type"/>
<meta content="https://embracelives.com/locations/child-counselling-in-greater-kailash" property="og:url"/>
<meta content="Child Counselling in Greater Kailash | eMbrace Delhi NCR" property="og:title"/>
<meta content="Child counselling in Greater Kailash for anxiety, anger, confidence and friendship difficulties, at our Malviya Nagar centre. Book a free intake call today." property="og:description"/>
...
<meta content="Child Counselling in Greater Kailash | eMbrace Delhi NCR" name="twitter:title"/>
<meta content="Child counselling in Greater Kailash for anxiety, anger, confidence and friendship difficulties, at our Malviya Nagar centre. Book a free intake call today." name="twitter:description"/>
<meta content="https://embracelives.com/og-image.png" name="twitter:image"/>
<title>Child Counselling in Greater Kailash | eMbrace Delhi NCR</title>
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://embracelives.com/locations/child-counselling-in-greater-kailash#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
        ...
        },
        {
          "@type": "ListItem",
          "position": 3,
          "name": "Child Counselling In Greater Kailash"
        }
      ]
    },
    {
      "@type": "MedicalWebPage",
      "@id": "https://embracelives.com/locations/child-counselling-in-greater-kailash#webpage",
      "url": "https://embracelives.com/locations/child-counselling-in-greater-kailash",
      "name": "Child Counselling in Greater Kailash | eMbrace Delhi NCR",
      "isPartOf": {
        "@id": "https://embracelives.com/#website"
      },
      "about": {
      ...
      "inLanguage": "en-IN",
      "description": "Child counselling in Greater Kailash for anxiety, anger, confidence and friendship difficulties, at our Malviya Nagar centre. Book a free intake call today.",
      "breadcrumb": {
        "@id": "https://embracelives.com/locations/child-counselling-in-greater-kailash#breadcrumb"
      }
    },
    {
      "@type": "FAQPage",
      "@id": "https://embracelives.com/locations/child-counselling-in-greater-kailash#faq",
      "url": "https://embracelives.com/locations/child-counselling-in-greater-kailash",
      "name": "Child Counselling in Greater Kailash | eMbrace Delhi NCR — Frequently Asked Questions",
      "isPartOf": {
        "@id": "https://embracelives.com/locations/child-counselling-in-greater-kailash#webpage"
      },
      "inLanguage": "en-IN",
      "mainEntity": [
        {
          "@type": "Question",
          "name": "Is there an eMbrace counselling centre in Greater Kailash?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "No. GK families come to our Malviya Nagar centre via Outer Ring Road and Press Enclave Marg. For a weekly appointment that journey is worth planning around."
          }
        },
        {
          "@type": "Question",
          "name": "Can we do some sessions online to make a weekly course workable?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes, and many GK families do exactly that. A mix of in-person and online sessions keeps a course running that would otherwise stop because of the travel."
          }
        },
        {
          "@type": "Question",
          "name": "My teenager refuses to talk to me. Will they talk to a counsellor?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Often, yes, and usually because a counsellor is not you. The first sessions establish that this is their space rather than an extension of a parental complaint."
          }
        },
        {
          "@type": "Question",
          "name": "The problem seems to be the whole family, not one child. Can you help with that?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes. A good number of referrals from this catchment start as one child and turn out to be about how the household handles conflict."
          }
        },
        {
          "@type": "Question",
          "name": "How much does child counselling cost in Greater Kailash?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Fees are quoted upfront on your free 15-minute intake call. It depends on the clinician and the work involved, so we quote your situation rather than an average."
          }
        }
      ]
    },
    {
      "@type": "Service",
      "@id": "https://embracelives.com/locations/child-counselling-in-greater-kailash#service",
      "name": "Child Counselling in Greater Kailash",
      ...
      "availableChannel": {
        "@type": "ServiceChannel",
        "serviceUrl": "https://embracelives.com/locations/child-counselling-in-greater-kailash",
...
<h1 class="text-3xl md:text-5xl font-extrabold text-[#234394] leading-tight mb-4">Child Counselling in Greater Kailash</h1>
<p class="text-base md:text-lg text-gray-600 max-w-3xl mx-auto italic">Professional child counselling for families in Greater Kailash, at our Malviya Nagar centre a short drive away.</p>
...
<span>/</span>
<span class="text-gray-800 font-medium">Child Counselling In Greater Kailash</span>
</div>
...
<p>Child counselling in Greater Kailash is the therapy itself: the weekly hour in which a child works on what is actually troubling them. The short answer is our Malviya Nagar centre, because we do not have a centre in Greater Kailash. This page covers what happens in that room, what you will and will not be told about it, and how long a course usually runs.</p>
...
<span class="font-semibold text-base md:text-lg text-[#234394] group-hover:text-purple-600 transition-colors">Is there an eMbrace counselling centre in Greater Kailash?</span>
...
<p class="text-sm md:text-base text-gray-600 mt-2 pb-2 leading-relaxed">No. GK families come to our Malviya Nagar centre via Outer Ring Road and Press Enclave Marg. For a weekly appointment that journey is worth planning around.</p>
</div>
</div>
<div class="faq-item">
<button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
<span class="font-semibold text-base md:text-lg text-[#234394] group-hover:text-purple-600 transition-colors">Can we do some sessions online to make a weekly course workable?</span>
<svg class="faq-icon" fill="none" stroke="#234394" stroke-linecap="round" stroke-width="2" viewbox="0 0 24 24"><path d="M12 5v14M5 12h14"></path></svg>
</button>
<div class="transition-all duration-300 max-h-0 opacity-0 overflow-hidden">
<p class="text-sm md:text-base text-gray-600 mt-2 pb-2 leading-relaxed">Yes, and many GK families do exactly that. A mix of in-person and online sessions keeps a course running that would otherwise stop because of the travel.</p>
</div>
</div>
<div class="faq-item">
<button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
<span class="font-semibold text-base md:text-lg text-[#234394] group-hover:text-purple-600 transition-colors">My teenager refuses to talk to me. Will they talk to a counsellor?</span>
<svg class="faq-icon" fill="none" stroke="#234394" stroke-linecap="round" stroke-width="2" viewbox="0 0 24 24"><path d="M12 5v14M5 12h14"></path></svg>
</button>
<div class="transition-all duration-300 max-h-0 opacity-0 overflow-hidden">
<p class="text-sm md:text-base text-gray-600 mt-2 pb-2 leading-relaxed">Often, yes, and usually because a counsellor is not you. The first sessions establish that this is their space rather than an extension of a parental complaint.</p>
</div>
</div>
<div class="faq-item">
<button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
<span class="font-semibold text-base md:text-lg text-[#234394] group-hover:text-purple-600 transition-colors">The problem seems to be the whole family, not one child. Can you help with that?</span>
<svg class="faq-icon" fill="none" stroke="#234394" stroke-linecap="round" stroke-width="2" viewbox="0 0 24 24"><path d="M12 5v14M5 12h14"></path></svg>
</button>
<div class="transition-all duration-300 max-h-0 opacity-0 overflow-hidden">
<p class="text-sm md:text-base text-gray-600 mt-2 pb-2 leading-relaxed">Yes. A good number of referrals from this catchment start as one child and turn out to be about how the household handles conflict.</p>
</div>
</div>
<div class="faq-item">
<button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
<span class="font-semibold text-base md:text-lg text-[#234394] group-hover:text-purple-600 transition-colors">How much does child counselling cost in Greater Kailash?</span>
<svg class="faq-icon" fill="none" stroke="#234394" stroke-linecap="round" stroke-width="2" viewbox="0 0 24 24"><path d="M12 5v14M5 12h14"></path></svg>
</button>
<div class="transition-all duration-300 max-h-0 opacity-0 overflow-hidden">
<p class="text-sm md:text-base text-gray-600 mt-2 pb-2 leading-relaxed">Fees are quoted upfront on your free 15-minute intake call. It depends on the clinician and the work involved, so we quote your situation rather than an average.</p>
</div>
</div>
</div>
...
<section class="emb-nearby" aria-labelledby="emb-nearby-title">
  ...
  <p class="emb-nearby__sub">Explore the other assessments and therapies we offer in Greater Kailash, or find child counselling at another eMbrace location.</p>
