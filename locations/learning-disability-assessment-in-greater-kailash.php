...
<script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    },
    {
      ...
      "name": "Learning Disability Assessment in Greater Kailash | eMbrace",
      "isPartOf": {
        "@id": "https://embracelives.com/#website"
      },
      "about": {
    ...
    },
    {
      ...
      "url": "https://embracelives.com/locations/learning-disability-assessment-in-greater-kailash",
      "name": "Learning Disability Assessment in Greater Kailash | eMbrace — Frequently Asked Questions",
      "isPartOf": {
        "@id": "https://embracelives.com/locations/learning-disability-assessment-in-greater-kailash#webpage"
      },
      "inLanguage": "en-IN",
      "mainEntity": [
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes, we offer professional learning disability assessment services at our Greater Kailash location and online. Our team of experienced professionals provides personalised care."
          }
        },
        {
          "@type": "Question",
...
<li><a class="block px-3 py-1.5 text-xs rounded-xl transition-all duration-200 bg-[#234394] text-white font-semibold" href="/learning-disabilities/learning-disabilities.php">Learning Disabilities Overview</a></li>
...
<li><a class="block px-3 py-1.5 text-xs rounded-xl transition-all duration-200 text-gray-600 hover:text-[#234394] hover:bg-white" href="/learning-disabilities/math-learning-disorder.php">Mathematics Learning Disorder</a></li>
</ul>
</div>
<div class="mb-6">
...
<li><a class="block py-1 text-xs text-[#234394] font-bold" href="/learning-disabilities/learning-disabilities.php">Learning Disabilities</a></li>
...
<li><a class="block py-1 text-xs text-gray-600" href="/learning-disabilities/math-learning-disorder.php">Math Learning Disorder</a></li>
</ul>
</div>
<div class="mb-4">
