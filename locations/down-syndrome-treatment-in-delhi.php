...
<div class="faq-item">
  <button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
    <span class="font-semibold text-[#1e293b] pr-4">Do you offer Down syndrome therapy in Delhi?</span>
...
<div class="faq-item">
  <button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
    <span class="font-semibold text-[#1e293b] pr-4">When should therapy start?</span>
    <svg class="faq-icon" viewBox="0 0 24 24" fill="none" stroke="#234394" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 9l6 6 6-6"/></svg>
  </button>
  <div class="faq-answer"><p class="px-4 pb-5 text-gray-600 leading-relaxed">As early as you are ready, often within the first months. Early physiotherapy and feeding support are usually first, with speech and occupational therapy following as your child develops.</p></div>
</div>
<div class="faq-item">
  <button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
    <span class="font-semibold text-[#1e293b] pr-4">Will using signs stop my child from speaking?</span>
    <svg class="faq-icon" viewBox="0 0 24 24" fill="none" stroke="#234394" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 9l6 6 6-6"/></svg>
  </button>
  <div class="faq-answer"><p class="px-4 pb-5 text-gray-600 leading-relaxed">No. Signs and picture systems give a child a way to communicate while speech develops, and research does not support the fear that they delay speech.</p></div>
</div>
</div>
