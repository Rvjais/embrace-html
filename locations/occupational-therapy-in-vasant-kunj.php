...
<meta content="Occupational therapy in Vasant Kunj for sensory processing, handwriting, fine motor and daily living skills, at our Vasant Kunj centre. Book a free intake call." name="description"/>
<meta content="index, follow" name="robots"/>
<link href="https://embracelives.com/locations/occupational-therapy-in-vasant-kunj" rel="canonical"/>
<meta content="website" property="og:type"/>
<meta content="https://embracelives.com/locations/occupational-therapy-in-vasant-kunj" property="og:url"/>
<meta content="Occupational Therapy in Vasant Kunj | eMbrace Delhi NCR" property="og:title"/>
<meta content="Occupational therapy in Vasant Kunj for sensory processing, handwriting, fine motor and daily living skills, at our Vasant Kunj centre. Book a free intake call." property="og:description"/>
...
<meta content="Occupational Therapy in Vasant Kunj | eMbrace Delhi NCR" name="twitter:title"/>
<meta content="Occupational therapy in Vasant Kunj for sensory processing, handwriting, fine motor and daily living skills, at our Vasant Kunj centre. Book a free intake call." name="twitter:description"/>
<meta content="https://embracelives.com/og-image.png" name="twitter:image"/>
<title>Occupational Therapy in Vasant Kunj | eMbrace Delhi NCR</title>
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://embracelives.com/locations/occupational-therapy-in-vasant-kunj#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
        ...
        },
        {
          "@type": "ListItem",
          "position": 3,
          "name": "Occupational Therapy In Vasant Kunj"
        }
      ]
    },
    {
      "@type": "MedicalWebPage",
      "@id": "https://embracelives.com/locations/occupational-therapy-in-vasant-kunj#webpage",
      "url": "https://embracelives.com/locations/occupational-therapy-in-vasant-kunj",
      "name": "Occupational Therapy in Vasant Kunj | eMbrace Delhi NCR",
      "isPartOf": {
        "@id": "https://embracelives.com/#website"
      },
      "about": {
      ...
      "inLanguage": "en-IN",
      "description": "Occupational therapy in Vasant Kunj for sensory processing, handwriting, fine motor and daily living skills, at our Vasant Kunj centre. Book a free intake call.",
      "breadcrumb": {
        "@id": "https://embracelives.com/locations/occupational-therapy-in-vasant-kunj#breadcrumb"
      }
    },
    {
      "@type": "FAQPage",
      "@id": "https://embracelives.com/locations/occupational-therapy-in-vasant-kunj#faq",
      "url": "https://embracelives.com/locations/occupational-therapy-in-vasant-kunj",
      "name": "Occupational Therapy in Vasant Kunj | eMbrace Delhi NCR — Frequently Asked Questions",
      "isPartOf": {
        "@id": "https://embracelives.com/locations/occupational-therapy-in-vasant-kunj#webpage"
      },
      "inLanguage": "en-IN",
      "mainEntity": [
        {
          "@type": "Question",
          "name": "Is your occupational therapist based here?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes. Dr Agrima Aggarwal works from Vasant Kunj and Gurugram, and this centre carries the broadest occupational therapy caseload."
          }
        },
        {
          "@type": "Question",
          "name": "Our school uses a different script and expects cursive earlier. Does that matter?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "It does. Expectations about script, speed and when cursive is introduced differ sharply between curricula, and the plan is written for the system you are in."
          }
        },
        {
          "@type": "Question",
          "name": "Can occupational therapy run alongside other therapies?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes, and here it usually does. Occupational therapy input into autism and developmental programmes runs in the same building as the rest."
          }
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "C-7, Sector C, Pocket 5, in the basement of Grand Vasant Kunj."
          }
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Quoted on your free 15-minute intake call, depending on the therapist and how often sessions run."
          }
        }
      ]
    },
    {
      "@type": "Service",
      "@id": "https://embracelives.com/locations/occupational-therapy-in-vasant-kunj#service",
      "name": "Occupational Therapy in Vasant Kunj",
      ...
      "availableChannel": {
        "@type": "ServiceChannel",
        "serviceUrl": "https://embracelives.com/locations/occupational-therapy-in-vasant-kunj",
...
<h1 class="text-3xl md:text-5xl font-extrabold text-[#234394] leading-tight mb-4">Occupational Therapy in Vasant Kunj</h1>
<p class="text-base md:text-lg text-gray-600 max-w-3xl mx-auto italic">Professional occupational therapy at our Vasant Kunj centre in New Delhi, in person or online.</p>
...
<span>/</span>
<span class="text-gray-800 font-medium">Occupational Therapy In Vasant Kunj</span>
</div>
...
<p>Occupational therapy in Vasant Kunj is the least well understood service we offer, so it is worth starting with what it is: helping someone do the ordinary things a day is made of. Dressing, handwriting, eating, sitting still enough to learn, tolerating noise and touch. The centre is in Vasant Kunj itself. It is not physiotherapy, and it is not tuition.</p>
...
<p>Vasant Kunj is where our occupational therapist is based, and the caseload reflects the breadth: sensory processing, handwriting, fine motor work, daily living skills and early intervention, alongside occupational therapy input into autism programmes running in the same building.</p>
<p>The international school catchment brings a particular version of the handwriting question, since expectations about script, speed and when cursive is introduced differ sharply between curricula.</p>
...
<p>Occupational therapy around Vasant Kunj is usually part of something larger, and these are the settings it connects to.</p>
...
<span class="font-semibold text-base md:text-lg text-[#234394] group-hover:text-purple-600 transition-colors">Is your occupational therapist based here?</span>
...
<p class="text-sm md:text-base text-gray-600 mt-2 pb-2 leading-relaxed">Yes. Dr Agrima Aggarwal works from Vasant Kunj and Gurugram, and this centre carries the broadest occupational therapy caseload.</p>
</div>
</div>
<div class="faq-item">
<button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
<span class="font-semibold text-base md:text-lg text-[#234394] group-hover:text-purple-600 transition-colors">Our school uses a different script and expects cursive earlier. Does that matter?</span>
<svg class="faq-icon" fill="none" stroke="#234394" stroke-linecap="round" stroke-width="2" viewbox="0 0 24 24"><path d="M12 5v14M5 12h14"></path></svg>
</button>
<div class="transition-all duration-300 max-h-0 opacity-0 overflow-hidden">
<p class="text-sm md:text-base text-gray-600 mt-2 pb-2 leading-relaxed">It does. Expectations about script, speed and when cursive is introduced differ sharply between curricula, and the plan is written for the system you are in.</p>
</div>
</div>
<div class="faq-item">
<button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
<span class="font-semibold text-base md:text-lg text-[#234394] group-hover:text-purple-600 transition-colors">Can occupational therapy run alongside other therapies?</span>
<svg class="faq-icon" fill="none" stroke="#234394" stroke-linecap="round" stroke-width="2" viewbox="0 0 24 24"><path d="M12 5v14M5 12h14"></path></svg>
</button>
<div class="transition-all duration-300 max-h-0 opacity-0 overflow-hidden">
<p class="text-sm md:text-base text-gray-600 mt-2 pb-2 leading-relaxed">Yes, and here it usually does. Occupational therapy input into autism and developmental programmes runs in the same building as the rest.</p>
</div>
</div>
<div class="faq-item">
<button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
...
<div class="transition-all duration-300 max-h-0 opacity-0 overflow-hidden">
<p class="text-sm md:text-base text-gray-600 mt-2 pb-2 leading-relaxed">C-7, Sector C, Pocket 5, in the basement of Grand Vasant Kunj.</p>
</div>
</div>
<div class="faq-item">
<button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
...
<div class="transition-all duration-300 max-h-0 opacity-0 overflow-hidden">
<p class="text-sm md:text-base text-gray-600 mt-2 pb-2 leading-relaxed">Quoted on your free 15-minute intake call, depending on the therapist and how often sessions run.</p>
</div>
</div>
</div>
...
<section class="emb-nearby" aria-labelledby="emb-nearby-title">
  ...
  <p class="emb-nearby__sub">Explore the other assessments and therapies we offer in Vasant Kunj, or find occupational therapy at another eMbrace location.</p>
