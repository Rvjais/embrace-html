...
<meta content="ADOS-2 based autism assessment in South Delhi by our clinical psychology team, at our Malviya Nagar and Vasant Kunj centres. Book a free intake call today." name="description"/>
<meta content="index, follow" name="robots"/>
<link href="https://embracelives.com/locations/autism-assessment-in-south-delhi" rel="canonical"/>
<meta content="website" property="og:type"/>
<meta content="https://embracelives.com/locations/autism-assessment-in-south-delhi" property="og:url"/>
<meta content="Autism Assessment &amp; Diagnosis in South Delhi | eMbrace Lives" property="og:title"/>
<meta content="ADOS-2 based autism assessment in South Delhi by our clinical psychology team, at our Malviya Nagar and Vasant Kunj centres. Book a free intake call today." property="og:description"/>
...
<meta content="Autism Assessment &amp; Diagnosis in South Delhi | eMbrace Lives" name="twitter:title"/>
<meta content="ADOS-2 based autism assessment in South Delhi by our clinical psychology team, at our Malviya Nagar and Vasant Kunj centres. Book a free intake call today." name="twitter:description"/>
<meta content="https://embracelives.com/og-image.png" name="twitter:image"/>
<title>Autism Assessment &amp; Diagnosis in South Delhi | eMbrace Lives</title>
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://embracelives.com/locations/autism-assessment-in-south-delhi#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
        ...
        },
        {
          "@type": "ListItem",
          "position": 3,
          "name": "Autism Assessment In South Delhi"
        }
      ]
    },
    {
      "@type": "MedicalWebPage",
      "@id": "https://embracelives.com/locations/autism-assessment-in-south-delhi#webpage",
      "url": "https://embracelives.com/locations/autism-assessment-in-south-delhi",
      "name": "Autism Assessment & Diagnosis in South Delhi | eMbrace Lives",
      "isPartOf": {
        "@id": "https://embracelives.com/#website"
      },
      "about": {
      ...
      "inLanguage": "en-IN",
      "description": "ADOS-2 based autism assessment in South Delhi by our clinical psychology team, at our Malviya Nagar and Vasant Kunj centres. Book a free intake call today.",
      "breadcrumb": {
        "@id": "https://embracelives.com/locations/autism-assessment-in-south-delhi#breadcrumb"
      }
    },
    {
      "@type": "FAQPage",
      "@id": "https://embracelives.com/locations/autism-assessment-in-south-delhi#faq",
      "url": "https://embracelives.com/locations/autism-assessment-in-south-delhi",
      "name": "Autism Assessment & Diagnosis in South Delhi | eMbrace Lives — Frequently Asked Questions",
      "isPartOf": {
        "@id": "https://embracelives.com/locations/autism-assessment-in-south-delhi#webpage"
      },
      "inLanguage": "en-IN",
      "mainEntity": [
        ...
        {
          "@type": "Question",
          "name": "My daughter was told she is just shy. Could it be autism?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Possibly. Girls are diagnosed later and less often because the presentation is frequently quieter, and late diagnosis is a growing part of this caseload."
          }
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Direct structured observation with ADOS-2, a detailed developmental history, structured tools including ISAA and CARS, plus communication and sensory input."
          }
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Two or three appointments plus report writing, usually across a few weeks. The expected timeline is given on the intake call."
          }
        },
        {
          "@type": "Question",
          "name": "How much does an autism assessment cost in South Delhi?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Quoted upfront on the free 15-minute intake call, as a single figure for the whole assessment."
          }
        }
      ]
    },
    {
      "@type": "Service",
      "@id": "https://embracelives.com/locations/autism-assessment-in-south-delhi#service",
      "name": "Autism Assessment in South Delhi",
      ...
      "availableChannel": {
        "@type": "ServiceChannel",
        "serviceUrl": "https://embracelives.com/locations/autism-assessment-in-south-delhi",
...
<h1 class="text-3xl md:text-5xl font-extrabold text-[#234394] leading-tight mb-4">Autism Assessment in South Delhi</h1>
<p class="text-base md:text-lg text-gray-600 max-w-3xl mx-auto italic">Professional autism assessment and diagnosis for families across South Delhi, at our Malviya Nagar and Vasant Kunj centres.</p>
...
<span>/</span>
<span class="text-gray-800 font-medium">Autism Assessment In South Delhi</span>
</div>
...
<p>An autism assessment in South Delhi is a structured diagnostic process built around watching your child directly, not around filling in forms about them. The short answer is either of our two south Delhi centres, Malviya Nagar or Vasant Kunj, and which one is a question of your journey rather than of the service. This page covers what the assessment involves, how young we can start, and what a diagnosis does and does not give you on paper.</p>
...
<p>Across south Delhi the caseload divides by age rather than by locality. Under-fives arrive through paediatricians with speech and social interaction concerns. School-age children arrive through schools once the social side of the day becomes the hard part.</p>
<p>The third and growing group is late diagnosis: girls, and adults, whose presentation was quieter and better camouflaged and who were told for years that nothing was wrong.</p>
...
<p>Families around South Delhi reach our autism assessment service through several routes, and the institutional ones are worth knowing about.</p>
...
<div class="faq-item">
<button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
<span class="font-semibold text-base md:text-lg text-[#234394] group-hover:text-purple-600 transition-colors">My daughter was told she is just shy. Could it be autism?</span>
<svg class="faq-icon" fill="none" stroke="#234394" stroke-linecap="round" stroke-width="2" viewbox="0 0 24 24"><path d="M12 5v14M5 12h14"></path></svg>
</button>
<div class="transition-all duration-300 max-h-0 opacity-0 overflow-hidden">
<p class="text-sm md:text-base text-gray-600 mt-2 pb-2 leading-relaxed">Possibly. Girls are diagnosed later and less often because the presentation is frequently quieter, and late diagnosis is a growing part of this caseload.</p>
</div>
</div>
<div class="faq-item">
<button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
<span class="font-semibold text-base md:text-lg text-[#234394] group-hover:text-purple-600 transition-colors">What tools do you use?</span>
<svg class="faq-icon" fill="none" stroke="#234394" stroke-linecap="round" stroke-width="2" viewbox="0 0 24 24"><path d="M12 5v14M5 12h14"></path></svg>
</button>
<div class="transition-all duration-300 max-h-0 opacity-0 overflow-hidden">
<p class="text-sm md:text-base text-gray-600 mt-2 pb-2 leading-relaxed">Direct structured observation with ADOS-2, a detailed developmental history, structured tools including ISAA and CARS, plus communication and sensory input.</p>
</div>
</div>
<div class="faq-item">
<button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
<span class="font-semibold text-base md:text-lg text-[#234394] group-hover:text-purple-600 transition-colors">How long does the process take?</span>
<svg class="faq-icon" fill="none" stroke="#234394" stroke-linecap="round" stroke-width="2" viewbox="0 0 24 24"><path d="M12 5v14M5 12h14"></path></svg>
</button>
<div class="transition-all duration-300 max-h-0 opacity-0 overflow-hidden">
<p class="text-sm md:text-base text-gray-600 mt-2 pb-2 leading-relaxed">Two or three appointments plus report writing, usually across a few weeks. The expected timeline is given on the intake call.</p>
</div>
</div>
<div class="faq-item">
<button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
<span class="font-semibold text-base md:text-lg text-[#234394] group-hover:text-purple-600 transition-colors">How much does an autism assessment cost in South Delhi?</span>
<svg class="faq-icon" fill="none" stroke="#234394" stroke-linecap="round" stroke-width="2" viewbox="0 0 24 24"><path d="M12 5v14M5 12h14"></path></svg>
</button>
<div class="transition-all duration-300 max-h-0 opacity-0 overflow-hidden">
<p class="text-sm md:text-base text-gray-600 mt-2 pb-2 leading-relaxed">Quoted upfront on the free 15-minute intake call, as a single figure for the whole assessment.</p>
</div>
</div>
</div>
...
<section class="emb-nearby" aria-labelledby="emb-nearby-title">
  ...
  <p class="emb-nearby__sub">Explore the other assessments and therapies we offer in South Delhi, or find autism assessments at another eMbrace location.</p>
