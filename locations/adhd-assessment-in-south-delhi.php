...
<meta content="ADHD assessment and treatment for children and teens in South Delhi, at our Malviya Nagar and Vasant Kunj centres. Book a free 15-minute call with a clinician." name="description"/>
<meta content="index, follow" name="robots"/>
<link href="https://embracelives.com/locations/adhd-assessment-in-south-delhi" rel="canonical"/>
<meta content="website" property="og:type"/>
<meta content="https://embracelives.com/locations/adhd-assessment-in-south-delhi" property="og:url"/>
<meta content="ADHD Assessment &amp; Treatment in South Delhi | eMbrace Lives" property="og:title"/>
<meta content="ADHD assessment and treatment for children and teens in South Delhi, at our Malviya Nagar and Vasant Kunj centres. Book a free 15-minute call with a clinician." property="og:description"/>
...
<meta content="ADHD Assessment &amp; Treatment in South Delhi | eMbrace Lives" name="twitter:title"/>
<meta content="ADHD assessment and treatment for children and teens in South Delhi, at our Malviya Nagar and Vasant Kunj centres. Book a free 15-minute call with a clinician." name="twitter:description"/>
<meta content="https://embracelives.com/og-image.png" name="twitter:image"/>
<title>ADHD Assessment &amp; Treatment in South Delhi | eMbrace Lives</title>
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://embracelives.com/locations/adhd-assessment-in-south-delhi#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
        ...
        },
        {
          "@type": "ListItem",
          "position": 3,
          "name": "Adhd Assessment In South Delhi"
        }
      ]
    },
    {
      "@type": "MedicalWebPage",
      "@id": "https://embracelives.com/locations/adhd-assessment-in-south-delhi#webpage",
      "url": "https://embracelives.com/locations/adhd-assessment-in-south-delhi",
      "name": "ADHD Assessment & Treatment in South Delhi | eMbrace Lives",
      "isPartOf": {
        "@id": "https://embracelives.com/#website"
      },
      "about": {
      ...
      "inLanguage": "en-IN",
      "description": "ADHD assessment and treatment for children and teens in South Delhi, at our Malviya Nagar and Vasant Kunj centres. Book a free 15-minute call with a clinician.",
      "breadcrumb": {
        "@id": "https://embracelives.com/locations/adhd-assessment-in-south-delhi#breadcrumb"
      }
    },
    {
      "@type": "FAQPage",
      "@id": "https://embracelives.com/locations/adhd-assessment-in-south-delhi#faq",
      "url": "https://embracelives.com/locations/adhd-assessment-in-south-delhi",
      "name": "ADHD Assessment & Treatment in South Delhi | eMbrace Lives — Frequently Asked Questions",
      "isPartOf": {
        "@id": "https://embracelives.com/locations/adhd-assessment-in-south-delhi#webpage"
      },
      "inLanguage": "en-IN",
      "mainEntity": [
        ...
        {
          "@type": "Question",
          "name": "My child coped until senior school. What changed?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Usually the amount of self-directed work. A child compensating on external structure stops coping when that structure falls away, which is the commonest pattern here."
          }
        },
        {
          "@type": "Question",
          "name": "What do we need for board concessions?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "That depends on the board, and requirements frequently involve a designated government centre. We will tell you what applies before you book anything."
          }
        },
        {
          "@type": "Question",
          "name": "Does school have to be involved?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes. Teacher rating scales are part of the assessment, because ADHD is defined partly by difficulties showing up in more than one setting."
          }
        },
        {
          "@type": "Question",
          "name": "How much does an ADHD assessment cost in South Delhi?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Quoted upfront on the free 15-minute intake call, as a single figure for the whole assessment rather than per session."
          }
        }
      ]
    },
    {
      "@type": "Service",
      "@id": "https://embracelives.com/locations/adhd-assessment-in-south-delhi#service",
      "name": "ADHD Assessment in South Delhi",
      ...
      "availableChannel": {
        "@type": "ServiceChannel",
        "serviceUrl": "https://embracelives.com/locations/adhd-assessment-in-south-delhi",
...
<h1 class="text-3xl md:text-5xl font-extrabold text-[#234394] leading-tight mb-4">ADHD Assessment in South Delhi</h1>
<p class="text-base md:text-lg text-gray-600 max-w-3xl mx-auto italic">Professional ADHD assessment and treatment for families across South Delhi, at our Malviya Nagar and Vasant Kunj centres.</p>
...
<span>/</span>
<span class="text-gray-800 font-medium">Adhd Assessment In South Delhi</span>
</div>
...
<p>An ADHD assessment in South Delhi is a finite piece of work with a written report at the end of it, not an open-ended course of therapy. The short answer is either of our two south Delhi centres, Malviya Nagar or Vasant Kunj, and which one is a question of your journey rather than of the service. This page sets out what the assessment involves, what the report is and is not accepted for, and who would carry it out.</p>
...
<p>Across south Delhi the assessment caseload is shaped by school density and by the point in the curriculum where self-directed work takes over. A large share of referrals cluster around the transition into the senior years, when external structure falls away and a compensating child stops coping.</p>
<p>Board years are the other cluster, where families want to know whether accommodations are available and what they would need to obtain them. That is a question about certification requirements as much as about diagnosis, and we would rather answer both.</p>
...
<p>A good deal of our assessment work around South Delhi reaches us through institutions rather than directly, and the referral routes are worth knowing about.</p>
...
<div class="faq-item">
<button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
<span class="font-semibold text-base md:text-lg text-[#234394] group-hover:text-purple-600 transition-colors">My child coped until senior school. What changed?</span>
<svg class="faq-icon" fill="none" stroke="#234394" stroke-linecap="round" stroke-width="2" viewbox="0 0 24 24"><path d="M12 5v14M5 12h14"></path></svg>
</button>
<div class="transition-all duration-300 max-h-0 opacity-0 overflow-hidden">
<p class="text-sm md:text-base text-gray-600 mt-2 pb-2 leading-relaxed">Usually the amount of self-directed work. A child compensating on external structure stops coping when that structure falls away, which is the commonest pattern here.</p>
</div>
</div>
<div class="faq-item">
<button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
<span class="font-semibold text-base md:text-lg text-[#234394] group-hover:text-purple-600 transition-colors">What do we need for board concessions?</span>
<svg class="faq-icon" fill="none" stroke="#234394" stroke-linecap="round" stroke-width="2" viewbox="0 0 24 24"><path d="M12 5v14M5 12h14"></path></svg>
</button>
<div class="transition-all duration-300 max-h-0 opacity-0 overflow-hidden">
<p class="text-sm md:text-base text-gray-600 mt-2 pb-2 leading-relaxed">That depends on the board, and requirements frequently involve a designated government centre. We will tell you what applies before you book anything.</p>
</div>
</div>
<div class="faq-item">
<button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
<span class="font-semibold text-base md:text-lg text-[#234394] group-hover:text-purple-600 transition-colors">Does school have to be involved?</span>
<svg class="faq-icon" fill="none" stroke="#234394" stroke-linecap="round" stroke-width="2" viewbox="0 0 24 24"><path d="M12 5v14M5 12h14"></path></svg>
</button>
<div class="transition-all duration-300 max-h-0 opacity-0 overflow-hidden">
<p class="text-sm md:text-base text-gray-600 mt-2 pb-2 leading-relaxed">Yes. Teacher rating scales are part of the assessment, because ADHD is defined partly by difficulties showing up in more than one setting.</p>
</div>
</div>
<div class="faq-item">
<button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
<span class="font-semibold text-base md:text-lg text-[#234394] group-hover:text-purple-600 transition-colors">How much does an ADHD assessment cost in South Delhi?</span>
<svg class="faq-icon" fill="none" stroke="#234394" stroke-linecap="round" stroke-width="2" viewbox="0 0 24 24"><path d="M12 5v14M5 12h14"></path></svg>
</button>
<div class="transition-all duration-300 max-h-0 opacity-0 overflow-hidden">
<p class="text-sm md:text-base text-gray-600 mt-2 pb-2 leading-relaxed">Quoted upfront on the free 15-minute intake call, as a single figure for the whole assessment rather than per session.</p>
</div>
</div>
</div>
...
<section class="emb-nearby" aria-labelledby="emb-nearby-title">
  ...
  <p class="emb-nearby__sub">Explore the other assessments and therapies we offer in South Delhi, or find ADHD assessments at another eMbrace location.</p>
