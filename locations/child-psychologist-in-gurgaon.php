...
<meta content="RCI-certified child psychologists in Gurgaon for anxiety, behaviour and developmental concerns, at our Gurugram centre on MG Road. Book a free 15-minute call." name="description"/>
...
<meta content="Child Psychologist in Gurgaon | RCI-Certified Team | eMbrace" property="og:title"/>
<meta content="RCI-certified child psychologists in Gurgaon for anxiety, behaviour and developmental concerns, at our Gurugram centre on MG Road. Book a free 15-minute call." property="og:description"/>
...
<meta content="Child Psychologist in Gurgaon | RCI-Certified Team | eMbrace" name="twitter:title"/>
<meta content="RCI-certified child psychologists in Gurgaon for anxiety, behaviour and developmental concerns, at our Gurugram centre on MG Road. Book a free 15-minute call." name="twitter:description"/>
<meta content="https://embracelives.com/og-image.png" name="twitter:image"/>
<title>Child Psychologist in Gurgaon | RCI-Certified Team | eMbrace</title>
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    },
    {
      ...
      "name": "Child Psychologist in Gurgaon | RCI-Certified Team | eMbrace",
      "isPartOf": {
        "@id": "https://embracelives.com/#website"
      },
      "about": {
      ...
      "inLanguage": "en-IN",
      "description": "RCI-certified child psychologists in Gurgaon for anxiety, behaviour and developmental concerns, at our Gurugram centre on MG Road. Book a free 15-minute call.",
      "breadcrumb": {
        "@id": "https://embracelives.com/locations/child-psychologist-in-gurgaon#breadcrumb"
      }
    },
    {
      ...
      "url": "https://embracelives.com/locations/child-psychologist-in-gurgaon",
      "name": "Child Psychologist in Gurgaon | RCI-Certified Team | eMbrace — Frequently Asked Questions",
      "isPartOf": {
        "@id": "https://embracelives.com/locations/child-psychologist-in-gurgaon#webpage"
      },
      "inLanguage": "en-IN",
      "mainEntity": [
        {
          "@type": "Question",
          "name": "Does eMbrace offer child psychologist in Gurgaon?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes, we offer professional child psychologist services at our Gurgaon location and online. Our team of experienced professionals provides personalised care."
          }
        },
        {
          "@type": "Question",
          "name": "How do I book child psychologist in Gurgaon?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          "name": "What are the qualifications of your child psychologist professionals in Gurgaon?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          "name": "Do you offer online child psychologist for Gurgaon residents?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes, we offer online child psychologist services for residents of Gurgaon who prefer remote consultations or have mobility concerns."
          }
        }
      ]
    },
...
<h2 class="text-2xl md:text-3xl font-bold mb-4 text-[#1e293b]">Child Psychologist Services in Gurgaon</h2>
<p class="text-lg text-gray-700 leading-relaxed font-light mb-8">Our team provides child psychology services for families in Gurgaon. Sessions run at our Gurugram centre on MG Road, with a free 15-minute intake call before you book anything.</p>
...
<span class="text-sm md:text-base text-gray-700"><strong>Expert Professionals:</strong> Our child psychologist team in Gurgaon consists of qualified, experienced professionals dedicated to providing exceptional care.</span>
</li>
<li class="flex items-start gap-3">
...
<span class="font-semibold text-base md:text-lg text-[#234394] group-hover:text-purple-600 transition-colors">Does eMbrace offer child psychologist in Gurgaon?</span>
...
<p class="text-sm md:text-base text-gray-600 mt-2 pb-2 leading-relaxed">
              Yes, we offer professional child psychologist services at our Gurgaon location and online. Our team of experienced professionals provides personalised care.
            </p>
</div>
</div>
<div class="faq-item">
<button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
<span class="font-semibold text-base md:text-lg text-[#234394] group-hover:text-purple-600 transition-colors">How do I book child psychologist in Gurgaon?</span>
<svg class="faq-icon" fill="none" stroke="#234394" stroke-linecap="round" stroke-width="2" viewbox="0 0 24 24"><path d="M12 5v14M5 12h14"></path></svg>
</button>
<div class="transition-all duration-300 max-h-0 opacity-0 overflow-hidden">
<p class="text-sm md:text-base text-gray-600 mt-2 pb-2 leading-relaxed">
...
<div class="faq-item">
<button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
<span class="font-semibold text-base md:text-lg text-[#234394] group-hover:text-purple-600 transition-colors">What are the qualifications of your child psychologist professionals in Gurgaon?</span>
<svg class="faq-icon" fill="none" stroke="#234394" stroke-linecap="round" stroke-width="2" viewbox="0 0 24 24"><path d="M12 5v14M5 12h14"></path></svg>
</button>
<div class="transition-all duration-300 max-h-0 opacity-0 overflow-hidden">
<p class="text-sm md:text-base text-gray-600 mt-2 pb-2 leading-relaxed">
...
<div class="faq-item">
<button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
<span class="font-semibold text-base md:text-lg text-[#234394] group-hover:text-purple-600 transition-colors">Do you offer online child psychologist for Gurgaon residents?</span>
<svg class="faq-icon" fill="none" stroke="#234394" stroke-linecap="round" stroke-width="2" viewbox="0 0 24 24"><path d="M12 5v14M5 12h14"></path></svg>
</button>
<div class="transition-all duration-300 max-h-0 opacity-0 overflow-hidden">
<p class="text-sm md:text-base text-gray-600 mt-2 pb-2 leading-relaxed">
              Yes, we offer online child psychologist services for residents of Gurgaon who prefer remote consultations or have mobility concerns.
            </p>
</div>
</div>
</div>
...
<p class="text-sm md:text-base text-gray-600 mb-6 max-w-xl mx-auto">Contact us today to schedule your child psychologist consultation at our Gurgaon centre.</p>
