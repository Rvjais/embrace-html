...
<meta content="Child counselling in Gurgaon for anxiety, anger, confidence and friendship difficulties, at our Gurugram centre on MG Road. Book a free intake call today." name="description"/>
<meta content="index, follow" name="robots"/>
<link href="https://embracelives.com/locations/child-counselling-in-gurgaon" rel="canonical"/>
<meta content="website" property="og:type"/>
<meta content="https://embracelives.com/locations/child-counselling-in-gurgaon" property="og:url"/>
<meta content="Child Counselling in Gurgaon | eMbrace Centres Delhi NCR" property="og:title"/>
<meta content="Child counselling in Gurgaon for anxiety, anger, confidence and friendship difficulties, at our Gurugram centre on MG Road. Book a free intake call today." property="og:description"/>
...
<meta content="Child Counselling in Gurgaon | eMbrace Centres Delhi NCR" name="twitter:title"/>
<meta content="Child counselling in Gurgaon for anxiety, anger, confidence and friendship difficulties, at our Gurugram centre on MG Road. Book a free intake call today." name="twitter:description"/>
<meta content="https://embracelives.com/og-image.png" name="twitter:image"/>
<title>Child Counselling in Gurgaon | eMbrace Centres Delhi NCR</title>
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://embracelives.com/locations/child-counselling-in-gurgaon#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
        ...
        },
        {
          "@type": "ListItem",
          "position": 3,
          "name": "Child Counselling In Gurgaon"
        }
      ]
    },
    {
      "@type": "MedicalWebPage",
      "@id": "https://embracelives.com/locations/child-counselling-in-gurgaon#webpage",
      "url": "https://embracelives.com/locations/child-counselling-in-gurgaon",
      "name": "Child Counselling in Gurgaon | eMbrace Centres Delhi NCR",
      "isPartOf": {
        "@id": "https://embracelives.com/#website"
      },
      "about": {
      ...
      "inLanguage": "en-IN",
      "description": "Child counselling in Gurgaon for anxiety, anger, confidence and friendship difficulties, at our Gurugram centre on MG Road. Book a free intake call today.",
      "breadcrumb": {
        "@id": "https://embracelives.com/locations/child-counselling-in-gurgaon#breadcrumb"
      }
    },
    {
      "@type": "FAQPage",
      "@id": "https://embracelives.com/locations/child-counselling-in-gurgaon#faq",
      "url": "https://embracelives.com/locations/child-counselling-in-gurgaon",
      "name": "Child Counselling in Gurgaon | eMbrace Centres Delhi NCR — Frequently Asked Questions",
      "isPartOf": {
        "@id": "https://embracelives.com/locations/child-counselling-in-gurgaon#webpage"
      },
      "inLanguage": "en-IN",
      "mainEntity": [
        {
          "@type": "Question",
          "name": "Where is child counselling in Gurgaon?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          "name": "Can my teenager come to counselling on their own?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes, and many do, given the metro is close. A young person who arrives under their own steam usually engages with counselling very differently from one who is delivered to it."
          }
        },
        {
          "@type": "Question",
          "name": "My younger child is angry and hard to manage at home. Is counselling the answer?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Often partly. With younger children the work is play-based and heavily parent-supported, because what changes at home matters more than the therapy hour itself."
          }
        },
        {
          "@type": "Question",
          "name": "Will you tell me what my child says in the session?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "You get themes, progress and what to do at home, not a transcript. Anything suggesting your child is at risk is always shared, and your child knows that from the start."
          }
        },
        {
          "@type": "Question",
          "name": "How much does child counselling cost in Gurgaon?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Fees are quoted on your free 15-minute intake call, before anything is booked, and depend on which clinician your child works with."
          }
        }
      ]
    },
    {
      "@type": "Service",
      "@id": "https://embracelives.com/locations/child-counselling-in-gurgaon#service",
      "name": "Child Counselling in Gurgaon",
      ...
      "availableChannel": {
        "@type": "ServiceChannel",
        "serviceUrl": "https://embracelives.com/locations/child-counselling-in-gurgaon",
...
<h1 class="text-3xl md:text-5xl font-extrabold text-[#234394] leading-tight mb-4">Child Counselling in Gurgaon</h1>
<p class="text-base md:text-lg text-gray-600 max-w-3xl mx-auto italic">Professional child counselling at our Gurugram centre on MG Road, Sector 24, Haryana.</p>
...
<span>/</span>
<span class="text-gray-800 font-medium">Child Counselling In Gurgaon</span>
</div>
...
<p>Child counselling in Gurgaon is the therapy itself: the weekly hour in which a child works on what is actually troubling them. The centre is in Gurgaon itself. This page covers what happens in that room, what you will and will not be told about it, and how long a course usually runs.</p>
...
<p>The Gurugram counselling caseload splits in two. Younger children come for anger, emotional regulation and behaviour that has become hard to manage at home, and that work is play-based and heavily parent-supported.</p>
<p>Adolescents come for anxiety, academic pressure and low mood, and here the metro connection does something genuinely useful: a teenager who will not be driven to a session by a parent will often travel to one alone, and a young person who arrives under their own steam engages with counselling in a completely different way from one who has been delivered to it.</p>
...
<span class="font-semibold text-base md:text-lg text-[#234394] group-hover:text-purple-600 transition-colors">Where is child counselling in Gurgaon?</span>
...
<div class="faq-item">
<button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
<span class="font-semibold text-base md:text-lg text-[#234394] group-hover:text-purple-600 transition-colors">Can my teenager come to counselling on their own?</span>
<svg class="faq-icon" fill="none" stroke="#234394" stroke-linecap="round" stroke-width="2" viewbox="0 0 24 24"><path d="M12 5v14M5 12h14"></path></svg>
</button>
<div class="transition-all duration-300 max-h-0 opacity-0 overflow-hidden">
<p class="text-sm md:text-base text-gray-600 mt-2 pb-2 leading-relaxed">Yes, and many do, given the metro is close. A young person who arrives under their own steam usually engages with counselling very differently from one who is delivered to it.</p>
</div>
</div>
<div class="faq-item">
<button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
<span class="font-semibold text-base md:text-lg text-[#234394] group-hover:text-purple-600 transition-colors">My younger child is angry and hard to manage at home. Is counselling the answer?</span>
<svg class="faq-icon" fill="none" stroke="#234394" stroke-linecap="round" stroke-width="2" viewbox="0 0 24 24"><path d="M12 5v14M5 12h14"></path></svg>
</button>
<div class="transition-all duration-300 max-h-0 opacity-0 overflow-hidden">
<p class="text-sm md:text-base text-gray-600 mt-2 pb-2 leading-relaxed">Often partly. With younger children the work is play-based and heavily parent-supported, because what changes at home matters more than the therapy hour itself.</p>
</div>
</div>
<div class="faq-item">
<button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
<span class="font-semibold text-base md:text-lg text-[#234394] group-hover:text-purple-600 transition-colors">Will you tell me what my child says in the session?</span>
<svg class="faq-icon" fill="none" stroke="#234394" stroke-linecap="round" stroke-width="2" viewbox="0 0 24 24"><path d="M12 5v14M5 12h14"></path></svg>
</button>
<div class="transition-all duration-300 max-h-0 opacity-0 overflow-hidden">
<p class="text-sm md:text-base text-gray-600 mt-2 pb-2 leading-relaxed">You get themes, progress and what to do at home, not a transcript. Anything suggesting your child is at risk is always shared, and your child knows that from the start.</p>
</div>
</div>
<div class="faq-item">
<button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
<span class="font-semibold text-base md:text-lg text-[#234394] group-hover:text-purple-600 transition-colors">How much does child counselling cost in Gurgaon?</span>
<svg class="faq-icon" fill="none" stroke="#234394" stroke-linecap="round" stroke-width="2" viewbox="0 0 24 24"><path d="M12 5v14M5 12h14"></path></svg>
</button>
<div class="transition-all duration-300 max-h-0 opacity-0 overflow-hidden">
<p class="text-sm md:text-base text-gray-600 mt-2 pb-2 leading-relaxed">Fees are quoted on your free 15-minute intake call, before anything is booked, and depend on which clinician your child works with.</p>
</div>
</div>
</div>
...
<section class="emb-nearby" aria-labelledby="emb-nearby-title">
  ...
  <p class="emb-nearby__sub">Explore the other assessments and therapies we offer in Gurgaon, or find child counselling at another eMbrace location.</p>
