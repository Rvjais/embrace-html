...
<meta content="Child counselling in Vasant Kunj using play, art and CBT-based work for anxiety, anger and low confidence, at our Vasant Kunj centre. Book a free intake call." name="description"/>
<meta content="index, follow" name="robots"/>
<link href="https://embracelives.com/locations/child-counselling-in-vasant-kunj" rel="canonical"/>
<meta content="website" property="og:type"/>
<meta content="https://embracelives.com/locations/child-counselling-in-vasant-kunj" property="og:url"/>
<meta content="Child Counselling in Vasant Kunj | RCI-Certified | eMbrace" property="og:title"/>
<meta content="Child counselling in Vasant Kunj using play, art and CBT-based work for anxiety, anger and low confidence, at our Vasant Kunj centre. Book a free intake call." property="og:description"/>
...
<meta content="Child Counselling in Vasant Kunj | RCI-Certified | eMbrace" name="twitter:title"/>
<meta content="Child counselling in Vasant Kunj using play, art and CBT-based work for anxiety, anger and low confidence, at our Vasant Kunj centre. Book a free intake call." name="twitter:description"/>
<meta content="https://embracelives.com/og-image.png" name="twitter:image"/>
<title>Child Counselling in Vasant Kunj | RCI-Certified | eMbrace</title>
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://embracelives.com/locations/child-counselling-in-vasant-kunj#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
        ...
        },
        {
          "@type": "ListItem",
          "position": 3,
          "name": "Child Counselling In Vasant Kunj"
        }
      ]
    },
    {
      "@type": "MedicalWebPage",
      "@id": "https://embracelives.com/locations/child-counselling-in-vasant-kunj#webpage",
      "url": "https://embracelives.com/locations/child-counselling-in-vasant-kunj",
      "name": "Child Counselling in Vasant Kunj | RCI-Certified | eMbrace",
      "isPartOf": {
        "@id": "https://embracelives.com/#website"
      },
      "about": {
      ...
      "inLanguage": "en-IN",
      "description": "Child counselling in Vasant Kunj using play, art and CBT-based work for anxiety, anger and low confidence, at our Vasant Kunj centre. Book a free intake call.",
      "breadcrumb": {
        "@id": "https://embracelives.com/locations/child-counselling-in-vasant-kunj#breadcrumb"
      }
    },
    {
      "@type": "FAQPage",
      "@id": "https://embracelives.com/locations/child-counselling-in-vasant-kunj#faq",
      "url": "https://embracelives.com/locations/child-counselling-in-vasant-kunj",
      "name": "Child Counselling in Vasant Kunj | RCI-Certified | eMbrace — Frequently Asked Questions",
      "isPartOf": {
        "@id": "https://embracelives.com/locations/child-counselling-in-vasant-kunj#webpage"
      },
      "inLanguage": "en-IN",
      "mainEntity": [
        {
          "@type": "Question",
          "name": "Does eMbrace offer child counselling in Vasant Kunj?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes, we offer professional child counselling services at our Vasant Kunj location and online. Our team of experienced professionals provides personalised care."
          }
        },
        {
          "@type": "Question",
          "name": "How do I book child counselling in Vasant Kunj?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          "name": "What are the qualifications of your child counselling professionals in Vasant Kunj?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          "name": "Do you offer online child counselling for Vasant Kunj residents?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes, we offer online child counselling services for residents of Vasant Kunj who prefer remote consultations or have mobility concerns."
          }
        }
      ]
    },
    {
      "@type": "Service",
      "@id": "https://embracelives.com/locations/child-counselling-in-vasant-kunj#service",
      "name": "Child Counselling in Vasant Kunj",
      ...
      "availableChannel": {
        "@type": "ServiceChannel",
        "serviceUrl": "https://embracelives.com/locations/child-counselling-in-vasant-kunj",
...
<h2 class="text-2xl md:text-3xl font-bold mb-4 text-[#1e293b]">Child Counselling Services in Vasant Kunj</h2>
<p class="text-lg text-gray-700 leading-relaxed font-light mb-8">Our team provides child counselling for families in Vasant Kunj. Sessions run at our Vasant Kunj centre, online or in person, with a free 15-minute intake call before you book anything.</p>
...
<span class="text-sm md:text-base text-gray-700"><strong>Expert Professionals:</strong> Our child counselling team in Vasant Kunj consists of qualified, experienced professionals dedicated to providing exceptional care.</span>
</li>
<li class="flex items-start gap-3">
...
<span class="font-semibold text-base md:text-lg text-[#234394] group-hover:text-purple-600 transition-colors">Does eMbrace offer child counselling in Vasant Kunj?</span>
...
<p class="text-sm md:text-base text-gray-600 mt-2 pb-2 leading-relaxed">
              Yes, we offer professional child counselling services at our Vasant Kunj location and online. Our team of experienced professionals provides personalised care.
            </p>
</div>
</div>
<div class="faq-item">
<button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
<span class="font-semibold text-base md:text-lg text-[#234394] group-hover:text-purple-600 transition-colors">How do I book child counselling in Vasant Kunj?</span>
<svg class="faq-icon" fill="none" stroke="#234394" stroke-linecap="round" stroke-width="2" viewbox="0 0 24 24"><path d="M12 5v14M5 12h14"></path></svg>
</button>
<div class="transition-all duration-300 max-h-0 opacity-0 overflow-hidden">
<p class="text-sm md:text-base text-gray-600 mt-2 pb-2 leading-relaxed">
...
<div class="faq-item">
<button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
<span class="font-semibold text-base md:text-lg text-[#234394] group-hover:text-purple-600 transition-colors">What are the qualifications of your child counselling professionals in Vasant Kunj?</span>
<svg class="faq-icon" fill="none" stroke="#234394" stroke-linecap="round" stroke-width="2" viewbox="0 0 24 24"><path d="M12 5v14M5 12h14"></path></svg>
</button>
<div class="transition-all duration-300 max-h-0 opacity-0 overflow-hidden">
<p class="text-sm md:text-base text-gray-600 mt-2 pb-2 leading-relaxed">
...
<div class="faq-item">
<button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
<span class="font-semibold text-base md:text-lg text-[#234394] group-hover:text-purple-600 transition-colors">Do you offer online child counselling for Vasant Kunj residents?</span>
<svg class="faq-icon" fill="none" stroke="#234394" stroke-linecap="round" stroke-width="2" viewbox="0 0 24 24"><path d="M12 5v14M5 12h14"></path></svg>
</button>
<div class="transition-all duration-300 max-h-0 opacity-0 overflow-hidden">
<p class="text-sm md:text-base text-gray-600 mt-2 pb-2 leading-relaxed">
              Yes, we offer online child counselling services for residents of Vasant Kunj who prefer remote consultations or have mobility concerns.
            </p>
</div>
</div>
</div>
...
<section class="emb-nearby" aria-labelledby="emb-nearby-title">
  ...
  <p class="emb-nearby__sub">Explore the other assessments and therapies we offer in Vasant Kunj, or find child counselling at another eMbrace location.</p>
