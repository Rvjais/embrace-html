...
<meta content="Developmental Pediatrician in Delhi at our two Delhi centres: medical diagnosis of autism, ADHD and delay, with one written plan. Book a free intake call today." name="description"/>
<meta content="index, follow" name="robots"/>
<link href="https://embracelives.com/locations/developmental-pediatrician-in-delhi" rel="canonical"/>
<!-- Open Graph -->
<meta content="website" property="og:type"/>
<meta content="https://embracelives.com/locations/developmental-pediatrician-in-delhi" property="og:url"/>
<meta content="Developmental Pediatrician in Delhi | eMbrace Delhi NCR" property="og:title"/>
<meta content="Developmental Pediatrician in Delhi at our two Delhi centres: medical diagnosis of autism, ADHD and delay, with one written plan. Book a free intake call today." property="og:description"/>
...
<meta content="Developmental Pediatrician in Delhi | eMbrace Delhi NCR" name="twitter:title"/>
<meta content="Developmental Pediatrician in Delhi at our two Delhi centres: medical diagnosis of autism, ADHD and delay, with one written plan. Book a free intake call today." name="twitter:description"/>
<meta content="https://embracelives.com/og-image.png" name="twitter:image"/>
<title>Developmental Pediatrician in Delhi | eMbrace Delhi NCR</title>
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://embracelives.com/locations/developmental-pediatrician-in-delhi#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
    ...
    {
      "@type": "MedicalWebPage",
      "@id": "https://embracelives.com/locations/developmental-pediatrician-in-delhi#webpage",
      "url": "https://embracelives.com/locations/developmental-pediatrician-in-delhi",
      "name": "Developmental Pediatrician in Delhi | eMbrace Delhi NCR",
      "isPartOf": {
        "@id": "https://embracelives.com/#website"
      },
      "about": {
      ...
      "inLanguage": "en-IN",
      "description": "Developmental Pediatrician in Delhi at our two Delhi centres: medical diagnosis of autism, ADHD and delay, with one written plan. Book a free intake call today.",
      "breadcrumb": {
        "@id": "https://embracelives.com/locations/developmental-pediatrician-in-delhi#breadcrumb"
      }
    },
    {
      "@type": "FAQPage",
      "@id": "https://embracelives.com/locations/developmental-pediatrician-in-delhi#faq",
      "url": "https://embracelives.com/locations/developmental-pediatrician-in-delhi",
      "name": "Developmental Pediatrician in Delhi | eMbrace Delhi NCR — Frequently Asked Questions",
      "isPartOf": {
        "@id": "https://embracelives.com/locations/developmental-pediatrician-in-delhi#webpage"
      },
      "inLanguage": "en-IN",
      "mainEntity": [
        {
          "@type": "Question",
          "name": "Do you have a developmental paediatrician on your team?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "We are a psychology and therapy practice. We do the developmental and psychological assessment; a medical opinion or prescription comes from a paediatrician."
          }
        },
        {
          "@type": "Question",
          "name": "So what can you actually do?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Map your child across all developmental areas, produce a written baseline, and identify which therapies would help. That is most of what families need and needs no doctor."
          }
        },
        {
          "@type": "Question",
          "name": "How do we get the medical side?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Our Malviya Nagar centre runs inside Rainbow, which is the practical reason that referral is usually short rather than a fresh search."
          }
        },
        {
          "@type": "Question",
          "name": "My child has lost skills they used to have. What should we do?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Seek medical review promptly as well as developmental assessment. Regression at any age needs both, and quickly."
          }
        },
        {
          "@type": "Question",
          "name": "How much does the developmental assessment cost?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Quoted upfront on your free 15-minute intake call. It covers assessment, report and feedback; medical care sits outside it."
          }
        }
      ]
    },
    {
      "@type": "Service",
      "@id": "https://embracelives.com/locations/developmental-pediatrician-in-delhi#service",
      "name": "Developmental Paediatrics in Delhi",
      ...
      "availableChannel": {
        "@type": "ServiceChannel",
        "serviceUrl": "https://embracelives.com/locations/developmental-pediatrician-in-delhi",
...
<aside class="md:w-72 flex-shrink-0">
  <div class="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm md:sticky md:top-24 side-menu">
    ...
    <div class="space-y-1">
      ...
      <a class="is-current" href="/developmental-pediatrics/developmental-pediatrician">Developmental Pediatrician</a>
...
<p>Developmental paediatrics in Delhi sits where medicine and development meet: milestones, growth, and the medical questions that can sit underneath a developmental difficulty. The short answer is both our Delhi centres, Vasant Kunj and Malviya Nagar, and which one is a question of your journey rather than of the service. This page is clear about which parts of that we do ourselves and which need a doctor.</p>
...
<p>Most Delhi referrals are about early milestones, particularly speech and motor together, in the first three years. Because our Malviya Nagar centre runs inside Rainbow, families needing both the developmental assessment and a paediatric opinion can usually get them at one address rather than two.</p>
...
<span class="font-semibold text-base md:text-lg text-[#234394] group-hover:text-purple-600 transition-colors">Do you have a developmental paediatrician on your team?</span>
...
<p class="text-sm md:text-base text-gray-600 mt-2 pb-2 leading-relaxed">We are a psychology and therapy practice. We do the developmental and psychological assessment; a medical opinion or prescription comes from a paediatrician.</p>
</div>
</div>
<div class="faq-item">
<button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
<span class="font-semibold text-base md:text-lg text-[#234394] group-hover:text-purple-600 transition-colors">So what can you actually do?</span>
<svg class="faq-icon" fill="none" stroke="#234394" stroke-linecap="round" stroke-width="2" viewbox="0 0 24 24"><path d="M12 5v14M5 12h14"></path></svg>
</button>
<div class="transition-all duration-300 max-h-0 opacity-0 overflow-hidden">
<p class="text-sm md:text-base text-gray-600 mt-2 pb-2 leading-relaxed">Map your child across all developmental areas, produce a written baseline, and identify which therapies would help. That is most of what families need and needs no doctor.</p>
</div>
</div>
<div class="faq-item">
<button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
<span class="font-semibold text-base md:text-lg text-[#234394] group-hover:text-purple-600 transition-colors">How do we get the medical side?</span>
<svg class="faq-icon" fill="none" stroke="#234394" stroke-linecap="round" stroke-width="2" viewbox="0 0 24 24"><path d="M12 5v14M5 12h14"></path></svg>
</button>
<div class="transition-all duration-300 max-h-0 opacity-0 overflow-hidden">
<p class="text-sm md:text-base text-gray-600 mt-2 pb-2 leading-relaxed">Our Malviya Nagar centre runs inside Rainbow, which is the practical reason that referral is usually short rather than a fresh search.</p>
</div>
</div>
<div class="faq-item">
<button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
<span class="font-semibold text-base md:text-lg text-[#234394] group-hover:text-purple-600 transition-colors">My child has lost skills they used to have. What should we do?</span>
<svg class="faq-icon" fill="none" stroke="#234394" stroke-linecap="round" stroke-width="2" viewbox="0 0 24 24"><path d="M12 5v14M5 12h14"></path></svg>
</button>
<div class="transition-all duration-300 max-h-0 opacity-0 overflow-hidden">
<p class="text-sm md:text-base text-gray-600 mt-2 pb-2 leading-relaxed">Seek medical review promptly as well as developmental assessment. Regression at any age needs both, and quickly.</p>
</div>
</div>
<div class="faq-item">
<button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
<span class="font-semibold text-base md:text-lg text-[#234394] group-hover:text-purple-600 transition-colors">How much does the developmental assessment cost?</span>
<svg class="faq-icon" fill="none" stroke="#234394" stroke-linecap="round" stroke-width="2" viewbox="0 0 24 24"><path d="M12 5v14M5 12h14"></path></svg>
</button>
<div class="transition-all duration-300 max-h-0 opacity-0 overflow-hidden">
<p class="text-sm md:text-base text-gray-600 mt-2 pb-2 leading-relaxed">Quoted upfront on your free 15-minute intake call. It covers assessment, report and feedback; medical care sits outside it.</p>
</div>
</div>
</div>
