  ...
  "@graph": [
    ...
    },
    {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "How is physiotherapy different from occupational therapy?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Physiotherapy works on movement itself: tone, strength, balance and coordination. Occupational therapy works on tasks, such as dressing, handwriting or tolerating a noisy room."
          }
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Our Malviya Nagar centre inside Rainbow, at FC-29 Geetanjali beside Malviya Nagar Metro Station Gate No. 1, where the other therapies also run."
          }
        },
        {
          "@type": "Question",
          "name": "My baby is not sitting yet. Is it too early to ask?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "No. Motor delay in the first two years is the commonest reason children are referred to us, and early is better than certain."
          }
        },
        {
          "@type": "Question",
          "name": "How much of it depends on us?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Most of it. Muscles respond to what happens most days, so the home programme moves more than the weekly session does."
          }
        },
        {
          "@type": "Question",
          "name": "How much does physiotherapy cost in Delhi?",
          "acceptedAnswer": {
            "@type": "Answer",
...
<aside class="md:w-72 flex-shrink-0">
  <div class="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm md:sticky md:top-24 side-menu">
    ...
    <div class="space-y-1">
      ...
      <a class="is-current" href="/physiotherapy/physiotherapy">Physiotherapy Clinic</a>
...
<p>Paediatric physiotherapy in Delhi is about movement: how a child holds themselves, gets around, and does the physical parts of an ordinary day. The short answer is both our Delhi centres, Vasant Kunj and Malviya Nagar, and which one is a question of your journey rather than of the service. It is not occupational therapy, which works on tasks rather than on movement itself.</p>
...
<p>At Malviya Nagar, which runs inside Rainbow, physiotherapy sits alongside occupational therapy, speech therapy and paediatric care, so a child needing more than one is not sent on a fresh search for each. The commonest referrals are motor delay in the first two years and neurological conditions including cerebral palsy.</p>
...
<p>Physiotherapy around Delhi usually sits inside something larger, and these are the settings it connects to.</p>
...
<span class="font-semibold text-base md:text-lg text-[#234394] group-hover:text-purple-600 transition-colors">How is physiotherapy different from occupational therapy?</span>
...
<p class="text-sm md:text-base text-gray-600 mt-2 pb-2 leading-relaxed">Physiotherapy works on movement itself: tone, strength, balance and coordination. Occupational therapy works on tasks, such as dressing, handwriting or tolerating a noisy room.</p>
</div>
</div>
<div class="faq-item">
<button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
...
<div class="transition-all duration-300 max-h-0 opacity-0 overflow-hidden">
<p class="text-sm md:text-base text-gray-600 mt-2 pb-2 leading-relaxed">Our Malviya Nagar centre inside Rainbow, at FC-29 Geetanjali beside Malviya Nagar Metro Station Gate No. 1, where the other therapies also run.</p>
</div>
</div>
<div class="faq-item">
<button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
<span class="font-semibold text-base md:text-lg text-[#234394] group-hover:text-purple-600 transition-colors">My baby is not sitting yet. Is it too early to ask?</span>
<svg class="faq-icon" fill="none" stroke="#234394" stroke-linecap="round" stroke-width="2" viewbox="0 0 24 24"><path d="M12 5v14M5 12h14"></path></svg>
</button>
<div class="transition-all duration-300 max-h-0 opacity-0 overflow-hidden">
<p class="text-sm md:text-base text-gray-600 mt-2 pb-2 leading-relaxed">No. Motor delay in the first two years is the commonest reason children are referred to us, and early is better than certain.</p>
</div>
</div>
<div class="faq-item">
<button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
<span class="font-semibold text-base md:text-lg text-[#234394] group-hover:text-purple-600 transition-colors">How much of it depends on us?</span>
<svg class="faq-icon" fill="none" stroke="#234394" stroke-linecap="round" stroke-width="2" viewbox="0 0 24 24"><path d="M12 5v14M5 12h14"></path></svg>
</button>
<div class="transition-all duration-300 max-h-0 opacity-0 overflow-hidden">
<p class="text-sm md:text-base text-gray-600 mt-2 pb-2 leading-relaxed">Most of it. Muscles respond to what happens most days, so the home programme moves more than the weekly session does.</p>
</div>
</div>
<div class="faq-item">
<button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
<span class="font-semibold text-base md:text-lg text-[#234394] group-hover:text-purple-600 transition-colors">How much does physiotherapy cost in Delhi?</span>
<svg class="faq-icon" fill="none" stroke="#234394" stroke-linecap="round" stroke-width="2" viewbox="0 0 24 24"><path d="M12 5v14M5 12h14"></path></svg>
</button>
<div class="transition-all duration-300 max-h-0 opacity-0 overflow-hidden">
