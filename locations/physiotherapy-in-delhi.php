...
<p>For the full clinical picture, including what the difficulty is, the signs worth acting on and how treatment is planned, read our <a href="/physiotherapy" class="text-[#234394] font-semibold">Physiotherapy Clinic guide</a>.</p>
...
<div class="faq-item">
  <button type="button" class="faq-btn" aria-expanded="false">
    <span class="faq-q">Do you offer physiotherapy in Delhi?</span>
...
<section class="emb-nearby" aria-labelledby="emb-nearby-title">
  ...
  <p class="emb-nearby__sub">Explore the other assessments and therapies we offer in Delhi, or find physiotherapy at another eMbrace location.</p>
  <div class="emb-nearby__cols emb-nearby__cols--two">
    ...
    <div class="emb-nearby__group">
      <h4>Physiotherapy in other areas</h4>
      <ul class="emb-nearby__list">
        null
        null
        null
