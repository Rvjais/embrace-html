...
<meta content="Adult counselling in Greater Kailash for anxiety, low mood, burnout and relationships, at our Malviya Nagar centre, a short drive away. Book a free intake call." name="description"/>
<meta content="index, follow" name="robots"/>
<link href="https://embracelives.com/locations/adult-counselling-in-greater-kailash" rel="canonical"/>
<meta content="website" property="og:type"/>
<meta content="https://embracelives.com/locations/adult-counselling-in-greater-kailash" property="og:url"/>
<meta content="Adult Counselling in Greater Kailash | eMbrace Delhi NCR" property="og:title"/>
<meta content="Adult counselling in Greater Kailash for anxiety, low mood, burnout and relationships, at our Malviya Nagar centre, a short drive away. Book a free intake call." property="og:description"/>
...
<meta content="Adult Counselling in Greater Kailash | eMbrace Delhi NCR" name="twitter:title"/>
<meta content="Adult counselling in Greater Kailash for anxiety, low mood, burnout and relationships, at our Malviya Nagar centre, a short drive away. Book a free intake call." name="twitter:description"/>
<meta content="https://embracelives.com/og-image.png" name="twitter:image"/>
<title>Adult Counselling in Greater Kailash | eMbrace Delhi NCR</title>
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://embracelives.com/locations/adult-counselling-in-greater-kailash#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
        ...
        },
        {
          "@type": "ListItem",
          "position": 3,
          "name": "Adult Counselling In Greater Kailash"
        }
      ]
    },
    {
      "@type": "MedicalWebPage",
      "@id": "https://embracelives.com/locations/adult-counselling-in-greater-kailash#webpage",
      "url": "https://embracelives.com/locations/adult-counselling-in-greater-kailash",
      "name": "Adult Counselling in Greater Kailash | eMbrace Delhi NCR",
      "isPartOf": {
        "@id": "https://embracelives.com/#website"
      },
      "about": {
      ...
      "inLanguage": "en-IN",
      "description": "Adult counselling in Greater Kailash for anxiety, low mood, burnout and relationships, at our Malviya Nagar centre, a short drive away. Book a free intake call.",
      "breadcrumb": {
        "@id": "https://embracelives.com/locations/adult-counselling-in-greater-kailash#breadcrumb"
      }
    },
    {
      "@type": "FAQPage",
      "@id": "https://embracelives.com/locations/adult-counselling-in-greater-kailash#faq",
      "url": "https://embracelives.com/locations/adult-counselling-in-greater-kailash",
      "name": "Adult Counselling in Greater Kailash | eMbrace Delhi NCR — Frequently Asked Questions",
      "isPartOf": {
        "@id": "https://embracelives.com/locations/adult-counselling-in-greater-kailash#webpage"
      },
      "inLanguage": "en-IN",
      "mainEntity": [
        {
          "@type": "Question",
          "name": "Do you offer couples counselling near Greater Kailash?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes. Couples work usually starts with a joint session, then an individual session with each partner, before the work proper begins. It runs from our Delhi centres."
          }
        },
        {
          "@type": "Question",
          "name": "Can I come on my own if my partner will not?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes, and it is often how this work starts. Individual therapy about a relationship is worthwhile in its own right, not a lesser substitute."
          }
        },
        {
          "@type": "Question",
          "name": "Where would I go from GK?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Our Malviya Nagar centre, via Outer Ring Road and Press Enclave Marg. Most people from this catchment drive rather than take the metro."
          }
        },
        {
          "@type": "Question",
          "name": "Three generations live in our house and that is the problem. Can therapy help?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Often yes. Intergenerational strain is a distinctive theme from this catchment and is usually structural rather than anybody behaving badly."
          }
        },
        {
          "@type": "Question",
          "name": "How much does adult counselling cost in Greater Kailash?",
          "acceptedAnswer": {
            "@type": "Answer",
    ...
    {
      "@type": "Service",
      "@id": "https://embracelives.com/locations/adult-counselling-in-greater-kailash#service",
      "name": "Adult Counselling in Greater Kailash",
      ...
      "availableChannel": {
        "@type": "ServiceChannel",
        "serviceUrl": "https://embracelives.com/locations/adult-counselling-in-greater-kailash",
...
<h1 class="text-3xl md:text-5xl font-extrabold text-[#234394] leading-tight mb-4">Adult Counselling in Greater Kailash</h1>
<p class="text-base md:text-lg text-gray-600 max-w-3xl mx-auto italic">Professional adult counselling for adults in Greater Kailash, at our Malviya Nagar centre a short drive away.</p>
...
<span>/</span>
<span class="text-gray-800 font-medium">Adult Counselling In Greater Kailash</span>
</div>
...
<p>Adult counselling in Greater Kailash is therapy for you, booked by you, with nobody else in the loop. The short answer is our Malviya Nagar centre, because we do not have a centre in Greater Kailash. Most people who contact us have been thinking about it for a year or more, so if you are only at the point of reading a page about it, that is a normal place to start.</p>
...
<p>From Greater Kailash, CR Park and Alaknanda the largest single group is relationship and marital work, both individual and couples, followed by anxiety and low mood in people in their forties and fifties.</p>
<p>Family and intergenerational conflict is a distinctive second theme, particularly in households where three generations share an address and the difficulty is structural rather than anybody behaving badly.</p>
...
<p>Some of the adult work we do around Greater Kailash runs through employers and partner services rather than through this website, which is often how someone first reaches us.</p>
...
<span class="font-semibold text-base md:text-lg text-[#234394] group-hover:text-purple-600 transition-colors">Do you offer couples counselling near Greater Kailash?</span>
...
<p class="text-sm md:text-base text-gray-600 mt-2 pb-2 leading-relaxed">Yes. Couples work usually starts with a joint session, then an individual session with each partner, before the work proper begins. It runs from our Delhi centres.</p>
</div>
</div>
<div class="faq-item">
<button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
<span class="font-semibold text-base md:text-lg text-[#234394] group-hover:text-purple-600 transition-colors">Can I come on my own if my partner will not?</span>
<svg class="faq-icon" fill="none" stroke="#234394" stroke-linecap="round" stroke-width="2" viewbox="0 0 24 24"><path d="M12 5v14M5 12h14"></path></svg>
</button>
<div class="transition-all duration-300 max-h-0 opacity-0 overflow-hidden">
<p class="text-sm md:text-base text-gray-600 mt-2 pb-2 leading-relaxed">Yes, and it is often how this work starts. Individual therapy about a relationship is worthwhile in its own right, not a lesser substitute.</p>
</div>
</div>
<div class="faq-item">
<button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
<span class="font-semibold text-base md:text-lg text-[#234394] group-hover:text-purple-600 transition-colors">Where would I go from GK?</span>
<svg class="faq-icon" fill="none" stroke="#234394" stroke-linecap="round" stroke-width="2" viewbox="0 0 24 24"><path d="M12 5v14M5 12h14"></path></svg>
</button>
<div class="transition-all duration-300 max-h-0 opacity-0 overflow-hidden">
<p class="text-sm md:text-base text-gray-600 mt-2 pb-2 leading-relaxed">Our Malviya Nagar centre, via Outer Ring Road and Press Enclave Marg. Most people from this catchment drive rather than take the metro.</p>
</div>
</div>
<div class="faq-item">
<button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
<span class="font-semibold text-base md:text-lg text-[#234394] group-hover:text-purple-600 transition-colors">Three generations live in our house and that is the problem. Can therapy help?</span>
<svg class="faq-icon" fill="none" stroke="#234394" stroke-linecap="round" stroke-width="2" viewbox="0 0 24 24"><path d="M12 5v14M5 12h14"></path></svg>
</button>
<div class="transition-all duration-300 max-h-0 opacity-0 overflow-hidden">
<p class="text-sm md:text-base text-gray-600 mt-2 pb-2 leading-relaxed">Often yes. Intergenerational strain is a distinctive theme from this catchment and is usually structural rather than anybody behaving badly.</p>
</div>
</div>
<div class="faq-item">
<button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
<span class="font-semibold text-base md:text-lg text-[#234394] group-hover:text-purple-600 transition-colors">How much does adult counselling cost in Greater Kailash?</span>
<svg class="faq-icon" fill="none" stroke="#234394" stroke-linecap="round" stroke-width="2" viewbox="0 0 24 24"><path d="M12 5v14M5 12h14"></path></svg>
</button>
<div class="transition-all duration-300 max-h-0 opacity-0 overflow-hidden">
...
<section class="emb-nearby" aria-labelledby="emb-nearby-title">
  ...
  <p class="emb-nearby__sub">Explore the other assessments and therapies we offer in Greater Kailash, or find adult counselling and therapy at another eMbrace location.</p>
