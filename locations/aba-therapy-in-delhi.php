...
<meta content="ABA Therapy in Delhi at our Vasant Kunj and Malviya Nagar centres: play-based, goals set with parents and reviewed against the data. Book a free intake call." name="description"/>
<meta content="index, follow" name="robots"/>
<link href="https://embracelives.com/locations/aba-therapy-in-delhi" rel="canonical"/>
<!-- Open Graph -->
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://embracelives.com/locations/aba-therapy-in-delhi#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
    ...
    },
    {
      ...
      "inLanguage": "en-IN",
      "description": "ABA Therapy in Delhi at our Vasant Kunj and Malviya Nagar centres: play-based, goals set with parents and reviewed against the data. Book a free intake call.",
      "breadcrumb": {
        "@id": "https://embracelives.com/locations/aba-therapy-in-delhi#breadcrumb"
      }
    },
    ...
    {
      "@type": "Service",
      "@id": "https://embracelives.com/locations/aba-therapy-in-delhi#service",
      "name": "ABA Therapy in Delhi",
      ...
      "availableChannel": {
        "@type": "ServiceChannel",
        "serviceUrl": "https://embracelives.com/locations/aba-therapy-in-delhi",
...
<div class="px-4 md:px-8 lg:px-16 py-14 md:py-20 bg-gradient-to-b from-[#E7F7FF] to-[#FFFFFF] text-center">
  <div class="max-w-4xl mx-auto">
    ...
    <h1 class="text-3xl md:text-5xl font-extrabold text-[#234394] leading-tight mb-4">ABA Therapy in Delhi</h1>
    <p class="text-base md:text-lg text-gray-600 max-w-3xl mx-auto">ABA Therapy for families in Delhi, delivered by the same multidisciplinary team that runs our assessments. This page covers where you will be seen, how to get there and what happens first.</p>
