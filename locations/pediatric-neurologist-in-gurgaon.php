  ...
  "@graph": [
    ...
    },
    {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "item": "https://embracelives.com/pediatric-neurology/pediatric-neurologist"
        }
      ]
    },
    {
    ...
    },
    {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "Do you offer paediatric neurology in Gurgaon?",
          "acceptedAnswer": {
            "@type": "Answer",
...
<div class="py-3 px-6 md:px-16 border-b border-gray-100 text-xs md:text-sm text-gray-500 breadcrumbs">
  <div class="max-w-7xl mx-auto flex items-center gap-2 flex-wrap">
      ...
      <a href="/pediatric-neurology/pediatric-neurologist.php">Pediatric Neurology</a><span class="text-gray-300">/</span>
...
<aside class="md:w-72 flex-shrink-0">
  <div class="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm md:sticky md:top-24 side-menu">
    ...
    <div class="space-y-1">
      ...
      <a class="is-current" href="/pediatric-neurology/pediatric-neurologist.php">Pediatric Neurologist</a>
...
<p>For the full clinical picture, including what the difficulty is, the signs worth acting on and how treatment is planned, read our <a href="/pediatric-neurology/pediatric-neurologist.php" class="text-[#234394] font-semibold">Pediatric Neurologist guide</a>.</p>
...
<div class="faq-item">
  <button type="button" class="faq-btn" aria-expanded="false">
    <span class="faq-q">Do you offer paediatric neurology in Gurgaon?</span>
