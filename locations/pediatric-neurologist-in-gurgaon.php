...
<meta content="Pediatric Neurologist in Gurgaon at our Gurugram centre on MG Road: seizures, regression, headaches, tone and movement concerns. Book a free intake call today." name="description"/>
<meta content="index, follow" name="robots"/>
<link href="https://embracelives.com/locations/pediatric-neurologist-in-gurgaon" rel="canonical"/>
<!-- Open Graph -->
<meta content="website" property="og:type"/>
<meta content="https://embracelives.com/locations/pediatric-neurologist-in-gurgaon" property="og:url"/>
<meta content="Pediatric Neurologist in Gurgaon | eMbrace Delhi NCR Centres" property="og:title"/>
<meta content="Pediatric Neurologist in Gurgaon at our Gurugram centre on MG Road: seizures, regression, headaches, tone and movement concerns. Book a free intake call today." property="og:description"/>
...
<meta content="Pediatric Neurologist in Gurgaon | eMbrace Delhi NCR Centres" name="twitter:title"/>
<meta content="Pediatric Neurologist in Gurgaon at our Gurugram centre on MG Road: seizures, regression, headaches, tone and movement concerns. Book a free intake call today." name="twitter:description"/>
<meta content="https://embracelives.com/og-image.png" name="twitter:image"/>
<title>Pediatric Neurologist in Gurgaon | eMbrace Delhi NCR Centres</title>
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://embracelives.com/locations/pediatric-neurologist-in-gurgaon#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
        ...
        },
        {
          ...
          "item": "https://embracelives.com/pediatric-neurologist"
        }
      ]
    },
    {
      "@type": "MedicalWebPage",
      "@id": "https://embracelives.com/locations/pediatric-neurologist-in-gurgaon#webpage",
      "url": "https://embracelives.com/locations/pediatric-neurologist-in-gurgaon",
      "name": "Pediatric Neurologist in Gurgaon | eMbrace Delhi NCR Centres",
      "isPartOf": {
        "@id": "https://embracelives.com/#website"
      },
      "about": {
      ...
      "inLanguage": "en-IN",
      "description": "Pediatric Neurologist in Gurgaon at our Gurugram centre on MG Road: seizures, regression, headaches, tone and movement concerns. Book a free intake call today.",
      "breadcrumb": {
        "@id": "https://embracelives.com/locations/pediatric-neurologist-in-gurgaon#breadcrumb"
      }
    },
    {
      "@type": "FAQPage",
      "@id": "https://embracelives.com/locations/pediatric-neurologist-in-gurgaon#faq",
      "url": "https://embracelives.com/locations/pediatric-neurologist-in-gurgaon",
      "name": "Pediatric Neurologist in Gurgaon | eMbrace Delhi NCR Centres — Frequently Asked Questions",
      "isPartOf": {
        "@id": "https://embracelives.com/locations/pediatric-neurologist-in-gurgaon#webpage"
      },
      "inLanguage": "en-IN",
      "mainEntity": [
        {
          "@type": "Question",
          "name": "Is there a paediatric neurologist at the Gurgaon centre?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "No, and we do not employ one anywhere. We provide neurodevelopmental assessment and therapy alongside whichever neurologist is treating your child."
          }
        },
        {
          "@type": "Question",
          "name": "We have a diagnosis. What would you add?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "What it means for learning and daily life, which is usually the question a diagnosis leaves unanswered, plus the therapy that follows from it."
          }
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Assessment and occupational therapy on site. Physiotherapy and speech and language therapy run from our Delhi centres, and we set that out before you commit."
          }
        },
        {
          "@type": "Question",
          "name": "We have not seen a neurologist yet. Should we?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "If the picture suggests one is needed we will say so plainly, rather than starting a therapy programme around an unanswered medical question."
          }
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Quoted upfront on your free 15-minute intake call, covering assessment and feedback. Medical care sits outside it."
          }
        }
      ]
    },
    {
      "@type": "Service",
      "@id": "https://embracelives.com/locations/pediatric-neurologist-in-gurgaon#service",
      "name": "Pediatric Neurology in Gurgaon",
      "serviceType": "Pediatric Neurology",
      "provider": {
        "@id": "https://embracelives.com/#organization"
      },
      "areaServed": {
      ...
      "availableChannel": {
        "@type": "ServiceChannel",
        "serviceUrl": "https://embracelives.com/locations/pediatric-neurologist-in-gurgaon",
...
<div class="px-4 md:px-8 lg:px-16 py-14 md:py-20 bg-gradient-to-b from-[#E7F7FF] to-[#FFFFFF] text-center">
  <div class="max-w-4xl mx-auto">
    ...
    <h1 class="text-3xl md:text-5xl font-extrabold text-[#234394] leading-tight mb-4">Pediatric Neurologist in Gurgaon</h1>
    <p class="text-base md:text-lg text-gray-600 max-w-3xl mx-auto">Pediatric Neurologist for families in Gurgaon, delivered by the same multidisciplinary team that runs our assessments. This page covers where you will be seen, how to get there and what happens first.</p>
...
<p>If you are searching for a paediatric neurologist in Gurgaon, the honest answer first: we are not one. The centre is in Gurgaon itself. What we provide is the neurodevelopmental assessment and therapy that runs alongside neurological care, and this page explains where the line sits.</p>
...
<p>Gurugram families usually come with a neurological diagnosis already made elsewhere and a question about what it means for learning and daily life. Assessment and occupational therapy run on site; physiotherapy and speech and language therapy run from our Delhi centres, which we set out before you commit.</p>
...
<p>A paediatric neurologist is a doctor and eMbrace is a psychology and therapy practice, so we do not employ one. What we provide is neurodevelopmental and psychological assessment and the therapy that follows, alongside whichever neurologist is treating your child. If a neurologist is what you actually need, we will say so on the free intake call.</p>
<h2>Schools and services we already work with</h2>
<p>Neurological care and developmental care have to talk to each other, and around Gurgaon that happens through:</p>
...
<span class="font-semibold text-base md:text-lg text-[#234394] group-hover:text-purple-600 transition-colors">Is there a paediatric neurologist at the Gurgaon centre?</span>
...
<p class="text-sm md:text-base text-gray-600 mt-2 pb-2 leading-relaxed">No, and we do not employ one anywhere. We provide neurodevelopmental assessment and therapy alongside whichever neurologist is treating your child.</p>
</div>
</div>
<div class="faq-item">
<button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
<span class="font-semibold text-base md:text-lg text-[#234394] group-hover:text-purple-600 transition-colors">We have a diagnosis. What would you add?</span>
<svg class="faq-icon" fill="none" stroke="#234394" stroke-linecap="round" stroke-width="2" viewbox="0 0 24 24"><path d="M12 5v14M5 12h14"></path></svg>
</button>
<div class="transition-all duration-300 max-h-0 opacity-0 overflow-hidden">
<p class="text-sm md:text-base text-gray-600 mt-2 pb-2 leading-relaxed">What it means for learning and daily life, which is usually the question a diagnosis leaves unanswered, plus the therapy that follows from it.</p>
</div>
</div>
<div class="faq-item">
<button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
...
<div class="transition-all duration-300 max-h-0 opacity-0 overflow-hidden">
<p class="text-sm md:text-base text-gray-600 mt-2 pb-2 leading-relaxed">Assessment and occupational therapy on site. Physiotherapy and speech and language therapy run from our Delhi centres, and we set that out before you commit.</p>
</div>
</div>
<div class="faq-item">
<button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
<span class="font-semibold text-base md:text-lg text-[#234394] group-hover:text-purple-600 transition-colors">We have not seen a neurologist yet. Should we?</span>
<svg class="faq-icon" fill="none" stroke="#234394" stroke-linecap="round" stroke-width="2" viewbox="0 0 24 24"><path d="M12 5v14M5 12h14"></path></svg>
</button>
<div class="transition-all duration-300 max-h-0 opacity-0 overflow-hidden">
<p class="text-sm md:text-base text-gray-600 mt-2 pb-2 leading-relaxed">If the picture suggests one is needed we will say so plainly, rather than starting a therapy programme around an unanswered medical question.</p>
</div>
</div>
<div class="faq-item">
<button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
...
<div class="transition-all duration-300 max-h-0 opacity-0 overflow-hidden">
<p class="text-sm md:text-base text-gray-600 mt-2 pb-2 leading-relaxed">Quoted upfront on your free 15-minute intake call, covering assessment and feedback. Medical care sits outside it.</p>
</div>
</div>
</div>
