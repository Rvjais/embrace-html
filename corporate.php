...
<html lang="en-IN">
  <head>
    ...
    <meta
      content="Employee wellness, neurodiversity training &amp; mental health workshops for corporates. Partner with eMbrace for workplace well-being programs in Delhi. Delhi NCR."
      name="description"
    />
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    {
      "@type": "WebPage",
      "@id": "https://embracelives.com/corporate#webpage",
      "url": "https://embracelives.com/corporate",
      "name": "Corporate Wellness & Mental Health Programs | eMbrace Lives",
      "isPartOf": {
        "@id": "https://embracelives.com/#website"
      },
      "about": {
      ...
      "inLanguage": "en-IN",
      "description": "Employee wellness, neurodiversity training & mental health workshops for corporates. Partner with eMbrace for workplace well-being programs in Delhi. Delhi NCR."
    }
  ]
}
</script>
<!-- SCHEMA:END -->
  ...
  <body>
    <div id="root">
      ...
      >
        <h2 class="md:text-3xl 2xl:text-4xl text-lg font-bold text-center">Our Workplace Programs</h2>
      ...
      <div class="px-4 md:px-8 lg:px-16 xl:px-24 2xl:px-50 py-14 flex flex-col items-center bg-gradient-to-b from-[#F0F9FF] to-[#FFFFFF]">
        <h2 class="md:text-3xl text-xl font-bold text-center">Our Work in Action</h2>
      ...
      >
        <h2 class="md:text-3xl 2xl:text-4xl text-lg font-bold text-center">
        ...
        <h2 class="md:text-3xl 2xl:text-4xl text-lg font-bold text-center mt-12">
