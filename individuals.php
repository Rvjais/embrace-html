...
<html lang="en-IN">
  <head>
    ...
    <meta
      content="Personalised therapy for individuals — anxiety, depression, OCD, trauma, ADHD &amp; more. Book confidential sessions with expert psychologists in Delhi. Delhi NCR."
      name="description"
    />
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    },
    {
      ...
      "inLanguage": "en-IN",
      "description": "Personalised therapy for individuals — anxiety, depression, OCD, trauma, ADHD & more. Book confidential sessions with expert psychologists in Delhi. Delhi NCR."
    }
  ]
}
</script>
  ...
  <body>
    <div id="root">
      ...
      >
        ...
        >
          <div class="flex flex-col items-center justify-center gap-4">
            <h2 class="md:text-3xl text-lg font-bold text-center 2xl:text-5xl">What We Offer</h2>
      ...
      >
        ...
        <div class="container mx-auto">
          <div class="flex flex-col items-center justify-center w-full">
            <h2 class="text-center text-2xl md:text-2xl lg:text-3xl font-bold">What Our Clients Say</h2>
      ...
      >
        ...
        <h2 class="text-xl md:text-3xl font-bold text-center 2xl:text-5xl">See Wellbeing Spaces in Action</h2>
      ...
      >
        ...
        <div class="max-w-3xl 2xl:max-w-5xl mx-auto">
          <div class="text-center mb-8">
            <h2 class="text-2xl 2xl:text-5xl xl:text-3xl font-bold text-gray-900">Frequently asked questions</h2>
          </div>
