...
<div class="faq-item">
  <button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
    <span class="font-semibold text-[#1e293b] pr-4">Do we need a diagnosis before coming?</span>
    <svg class="faq-icon" viewBox="0 0 24 24" fill="none" stroke="#234394" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 9l6 6 6-6"/></svg>
  </button>
  <div class="faq-answer"><p class="px-4 pb-5 text-gray-600 leading-relaxed">No. Many families arrive with a concern rather than a diagnosis, and working out whether there is anything to diagnose is part of what we do.</p></div>
</div>
<div class="faq-item">
  <button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
    <span class="font-semibold text-[#1e293b] pr-4">How much does it cost?</span>
    <svg class="faq-icon" viewBox="0 0 24 24" fill="none" stroke="#234394" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 9l6 6 6-6"/></svg>
  </button>
  <div class="faq-answer"><p class="px-4 pb-5 text-gray-600 leading-relaxed">Fees depend on the service and are quoted upfront on your intake call, in writing, before you commit to anything. There are no surprise charges later.</p></div>
</div>
<div class="faq-item">
  <button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
    <span class="font-semibold text-[#1e293b] pr-4">Can everything be done online?</span>
    <svg class="faq-icon" viewBox="0 0 24 24" fill="none" stroke="#234394" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 9l6 6 6-6"/></svg>
  </button>
  <div class="faq-answer"><p class="px-4 pb-5 text-gray-600 leading-relaxed">History-taking, feedback and much of therapy work well online. Direct assessment components, particularly ADOS-2 for autism, need to be done in person.</p></div>
</div>
</div>
