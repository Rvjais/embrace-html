...
<link href="https://embracelives.com/pediatric-neurology/pediatric-neurologist" rel="canonical"/>
<!-- Open Graph -->
<meta content="website" property="og:type"/>
<meta content="https://embracelives.com/pediatric-neurology/pediatric-neurologist" property="og:url"/>
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://embracelives.com/pediatric-neurology/pediatric-neurologist#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
    ...
    {
      "@type": "WebPage",
      "@id": "https://embracelives.com/pediatric-neurology/pediatric-neurologist#webpage",
      "url": "https://embracelives.com/pediatric-neurology/pediatric-neurologist",
    ...
    {
      "@type": "FAQPage",
      "@id": "https://embracelives.com/pediatric-neurology/pediatric-neurologist#faq",
      "url": "https://embracelives.com/pediatric-neurology/pediatric-neurologist",
...
<ul>
  <li><a href="/locations/pediatric-neurologist-in-delhi.php" class="text-[#234394] font-semibold">Pediatric Neurologist in Delhi</a></li>
  <li><a href="/locations/pediatric-neurologist-in-gurgaon.php" class="text-[#234394] font-semibold">Pediatric Neurologist in Gurgaon</a></li>
...
<div class="faq-item">
  <button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
    <span class="font-semibold text-[#1e293b] pr-4">What should I bring to the appointment?</span>
    <svg class="faq-icon" viewBox="0 0 24 24" fill="none" stroke="#234394" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 9l6 6 6-6"/></svg>
  </button>
  <div class="faq-answer"><p class="px-4 pb-5 text-gray-600 leading-relaxed">Previous reports, discharge summaries, immunisation and growth records, a list of medicines, and a phone video of anything unusual you have seen. Video is genuinely valuable.</p></div>
</div>
<div class="faq-item">
  <button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
    <span class="font-semibold text-[#1e293b] pr-4">Is a referral required?</span>
    <svg class="faq-icon" viewBox="0 0 24 24" fill="none" stroke="#234394" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 9l6 6 6-6"/></svg>
  </button>
  <div class="faq-answer"><p class="px-4 pb-5 text-gray-600 leading-relaxed">No. You can book directly. If your paediatrician has already sent notes or investigations, bring them so nothing is repeated unnecessarily.</p></div>
</div>
<div class="faq-item">
  <button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
    <span class="font-semibold text-[#1e293b] pr-4">Do you treat epilepsy long term?</span>
    <svg class="faq-icon" viewBox="0 0 24 24" fill="none" stroke="#234394" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 9l6 6 6-6"/></svg>
  </button>
  <div class="faq-answer"><p class="px-4 pb-5 text-gray-600 leading-relaxed">Yes, including medication management and review. We coordinate with your paediatrician and, where needed, with the school so staff know what to do.</p></div>
</div>
</div>
