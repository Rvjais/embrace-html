...
<html lang="en-IN">
  <head>
    ...
    <meta content="Trauma therapy in Delhi. EMDR, TF-CBT, and somatic approaches for PTSD and complex trauma. From eMbrace, a multidisciplinary practice across Delhi NCR." name="description" />
    <meta content="index, follow" name="robots" />
    <link href="https://embracelives.com/adult-mental-health/trauma-therapy" rel="canonical" />
    <meta content="website" property="og:type" />
    <meta content="https://embracelives.com/adult-mental-health/trauma-therapy" property="og:url" />
    <meta content="Trauma Therapy | A Guide from eMbrace | eMbrace Delhi NCR" property="og:title" />
    <meta content="Trauma therapy in Delhi. EMDR, TF-CBT, and somatic approaches for PTSD and complex trauma. From eMbrace, a multidisciplinary practice across Delhi NCR." property="og:description" />
    ...
    <meta content="Trauma Therapy | A Guide from eMbrace | eMbrace Delhi NCR" name="twitter:title" />
    <meta content="Trauma therapy in Delhi. EMDR, TF-CBT, and somatic approaches for PTSD and complex trauma. From eMbrace, a multidisciplinary practice across Delhi NCR." name="twitter:description" />
    <meta content="https://embracelives.com/og-image.png" name="twitter:image" />
    <title>Trauma Therapy | A Guide from eMbrace | eMbrace Delhi NCR</title>
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://embracelives.com/adult-mental-health/trauma-therapy#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
    ...
    {
      "@type": "MedicalWebPage",
      "@id": "https://embracelives.com/adult-mental-health/trauma-therapy#webpage",
      "url": "https://embracelives.com/adult-mental-health/trauma-therapy",
      "name": "Trauma Therapy | A Guide from eMbrace | eMbrace Delhi NCR",
      "isPartOf": {
        "@id": "https://embracelives.com/#website"
      },
      "about": {
      ...
      "inLanguage": "en-IN",
      "description": "Trauma therapy in Delhi. EMDR, TF-CBT, and somatic approaches for PTSD and complex trauma. From eMbrace, a multidisciplinary practice across Delhi NCR.",
      "breadcrumb": {
        "@id": "https://embracelives.com/adult-mental-health/trauma-therapy#breadcrumb"
      }
    },
    {
      "@type": "FAQPage",
      "@id": "https://embracelives.com/adult-mental-health/trauma-therapy#faq",
      "url": "https://embracelives.com/adult-mental-health/trauma-therapy",
      "name": "Trauma Therapy | A Guide from eMbrace | eMbrace Delhi NCR — Frequently Asked Questions",
      "isPartOf": {
        "@id": "https://embracelives.com/adult-mental-health/trauma-therapy#webpage"
      },
      "inLanguage": "en-IN",
      "mainEntity": [
        {
          "@type": "Question",
          "name": "Do I need to talk about the trauma in detail?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "No — we work at your pace and use approaches that don't require detailed retelling if you prefer not to."
          }
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "For single-incident trauma, 8-12 sessions may suffice. Complex trauma typically requires longer-term work."
          }
        }
      ]
    }
...
<div class="w-full md:w-80 flex-shrink-0 bg-[#F9FBFF] border border-[#E0E6F0] rounded-3xl p-6 hidden md:block max-h-[85vh] overflow-y-auto sticky top-6 shadow-sm">
  ...
  <div class="mb-6">
    ...
    <ul class="space-y-1 ml-2">
      ...
      <li><a class="block px-3 py-1.5 text-xs rounded-xl transition-all duration-200 bg-[#234394] text-white font-semibold" href="/adult-mental-health/trauma-therapy.php">Trauma Therapy</a></li>
    ...
    <div class="mt-4 pt-3 border-t border-gray-200 max-h-[60vh] overflow-y-auto">
      ...
      <div class="mb-4">
        ...
        <ul class="space-y-1 ml-1">
          ...
          <li><a class="block py-1 text-xs text-[#234394] font-bold" href="/adult-mental-health/trauma-therapy.php">Trauma Therapy</a></li>
