...
<html lang="en-IN">
  <head>
    ...
    <meta content="Relationship counselling in Delhi. Improve communication, resolve conflicts, and strengthen your relationships. Guidance from our clinical team in Delhi NCR." name="description" />
    <meta content="index, follow" name="robots" />
    <link href="https://embracelives.com/adult-mental-health/relationship-counselling" rel="canonical" />
    <meta content="website" property="og:type" />
    <meta content="https://embracelives.com/adult-mental-health/relationship-counselling" property="og:url" />
    <meta content="Relationship Counselling | eMbrace Child Psychology Delhi" property="og:title" />
    <meta content="Relationship counselling in Delhi. Improve communication, resolve conflicts, and strengthen your relationships. Guidance from our clinical team in Delhi NCR." property="og:description" />
    ...
    <meta content="Relationship Counselling | eMbrace Child Psychology Delhi" name="twitter:title" />
    <meta content="Relationship counselling in Delhi. Improve communication, resolve conflicts, and strengthen your relationships. Guidance from our clinical team in Delhi NCR." name="twitter:description" />
    <meta content="https://embracelives.com/og-image.png" name="twitter:image" />
    <title>Relationship Counselling | eMbrace Child Psychology Delhi</title>
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://embracelives.com/adult-mental-health/relationship-counselling#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
    ...
    {
      "@type": "MedicalWebPage",
      "@id": "https://embracelives.com/adult-mental-health/relationship-counselling#webpage",
      "url": "https://embracelives.com/adult-mental-health/relationship-counselling",
      "name": "Relationship Counselling | eMbrace Child Psychology Delhi",
      "isPartOf": {
        "@id": "https://embracelives.com/#website"
      },
      "about": {
      ...
      "inLanguage": "en-IN",
      "description": "Relationship counselling in Delhi. Improve communication, resolve conflicts, and strengthen your relationships. Guidance from our clinical team in Delhi NCR.",
      "breadcrumb": {
        "@id": "https://embracelives.com/adult-mental-health/relationship-counselling#breadcrumb"
      }
    },
    {
      "@type": "FAQPage",
      "@id": "https://embracelives.com/adult-mental-health/relationship-counselling#faq",
      "url": "https://embracelives.com/adult-mental-health/relationship-counselling",
      "name": "Relationship Counselling | eMbrace Child Psychology Delhi — Frequently Asked Questions",
      "isPartOf": {
        "@id": "https://embracelives.com/adult-mental-health/relationship-counselling#webpage"
      },
      "inLanguage": "en-IN",
      "mainEntity": [
        {
          "@type": "Question",
          "name": "When should we seek relationship counselling?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Don't wait for a crisis — early intervention when communication breaks down is most effective."
          }
        },
        {
          "@type": "Question",
          "name": "Will counselling help if only one partner wants to come?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes — individual work on relationship patterns can create positive changes even when only one partner participates."
          }
        }
      ]
    }
...
<div class="w-full md:w-80 flex-shrink-0 bg-[#F9FBFF] border border-[#E0E6F0] rounded-3xl p-6 hidden md:block max-h-[85vh] overflow-y-auto sticky top-6 shadow-sm">
  ...
  <div class="mb-6">
    ...
    <ul class="space-y-1 ml-2">
      ...
      <li><a class="block px-3 py-1.5 text-xs rounded-xl transition-all duration-200 bg-[#234394] text-white font-semibold" href="/adult-mental-health/relationship-counselling.php">Relationship Counselling</a></li>
    ...
    <div class="mt-4 pt-3 border-t border-gray-200 max-h-[60vh] overflow-y-auto">
      ...
      <div class="mb-4">
        ...
        <ul class="space-y-1 ml-1">
          ...
          <li><a class="block py-1 text-xs text-[#234394] font-bold" href="/adult-mental-health/relationship-counselling.php">Relationship Counselling</a></li>
