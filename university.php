...
<html lang="en-IN">
  <head>
    ...
    <meta
      content="Mental health services for universities — student counselling, faculty training, internship programs &amp; campus well-being initiatives with eMbrace. Delhi NCR."
      name="description"
    />
    ...
    <meta content="University Counselling &amp; Campus Mental Health | eMbrace" property="og:title" />
    <meta
      content="Mental health services for universities — student counselling, faculty training, internship programs &amp; campus well-being initiatives with eMbrace. Delhi NCR."
    ...
    <meta content="University Counselling &amp; Campus Mental Health | eMbrace" name="twitter:title" />
    <meta
      content="Mental health services for universities — student counselling, faculty training, internship programs &amp; campus well-being initiatives with eMbrace. Delhi NCR."
...
<title>University Counselling &amp; Campus Mental Health | eMbrace</title>
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    },
    {
      ...
      "name": "University Counselling & Campus Mental Health | eMbrace",
      "isPartOf": {
        "@id": "https://embracelives.com/#website"
      },
      "about": {
      ...
      "inLanguage": "en-IN",
      "description": "Mental health services for universities — student counselling, faculty training, internship programs & campus well-being initiatives with eMbrace. Delhi NCR."
    }
  ]
}
</script>
    ...
    <div id="root">
      ...
      <div class="overflow-hidden flex flex-col items-center px-4 md:px-8 lg:px-16 xl:px-20 py-6 relative">
        <div class="flex flex-col items-center">
          <h2 class="text-xl md:text-3xl font-bold text-center">Why Universities choose embrace?</h2>
          <div class="flex flex-col md:flex-row gap-6 md:gap-4 mt-6">
            ...
            >
              <img loading="lazy" decoding="async" width="398" height="218" alt="Why Embrace 2" class="w-[90%] md:w-full mb-2" src="/assets/EvidenceBased-DPD1TwX2.svg" />
            ...
            <div
              class="bg-white border-2 border-gray-200 rounded-4xl p-6 flex flex-col items-center mx-auto w-[90%] md:w-[50%] h-auto"
            >
              <img loading="lazy" decoding="async" width="398" height="218" alt="Why Embrace 2" class="w-[90%] md:w-full mb-2" src="/assets/FacultyAndStaff-DJdEEIOh.svg" />
              <div class="text-start">
                <h2 class="text-base italic font-semibold mb-2 text-center text-[var(--blue-fig)]">
            ...
            <div
              class="bg-white border-2 border-gray-200 rounded-4xl p-6 flex flex-col items-center mx-auto w-[90%] md:w-[50%] h-auto"
            >
              <img loading="lazy" decoding="async" width="398" height="218" alt="Why Embrace 2" class="w-[90%] md:w-full mb-2" src="/assets/SeamlessCampus-Xzj0QDHk.svg" />
              <div class="text-start">
                <h2 class="text-base italic font-semibold mb-2 text-center text-[var(--blue-fig)]">
          ...
          <h2 class="text-xl md:text-3xl font-bold mt-8 text-center">Trusted by Forward-Thinking Institutions</h2>
          <div class="flex flex-col md:flex-row gap-6 md:gap-16 mt-3 justify-center items-center flex-wrap mb-4">
            ...
            >
              <img loading="lazy" decoding="async" width="249" height="104"
                alt="Trusted 1"
      ...
      >
        ...
        <h2 class="text-xl md:text-3xl font-bold text-center">Student Programs</h2>
        <div class="flex flex-col md:flex-row gap-6 md:gap-4 mt-6">
          <div
            class="bg-white border-2 border-gray-200 rounded-4xl p-6 flex flex-col items-center mx-auto w-[90%] md:w-[50%] h-auto"
          >
      ...
      >
        ...
        <h2 class="text-xl md:text-3xl font-bold text-center">Faculty Staff Training &amp; Support</h2>
        <div class="flex flex-col md:flex-row gap-6 md:gap-4 mt-6">
          <div
            class="bg-white border-2 border-gray-200 rounded-4xl p-6 flex flex-col items-center mx-auto w-[90%] md:w-[50%] h-auto"
          >
            <img loading="lazy" decoding="async" width="549" height="338"
              alt="Why Embrace 2"
          ...
          <div
            class="bg-white border-2 border-gray-200 rounded-4xl p-6 flex flex-col items-center mx-auto w-[90%] md:w-[50%] h-auto"
          >
            <img loading="lazy" decoding="async" width="549" height="338" alt="Why Embrace 2" class="w-[90%] md:w-full md:mb-12 mb-4" src="/assets/Classrooms-C7WypI4b.svg" />
            <div class="text-start">
              <h2 class="text-base md:text-lg italic font-semibold mb-4 md:mb-6 text-center text-[var(--blue-fig)]">
          ...
          <div
            class="bg-white border-2 border-gray-200 rounded-4xl p-6 flex flex-col items-center mx-auto w-[90%] md:w-[50%] h-auto"
          >
            <img loading="lazy" decoding="async" width="549" height="338" alt="Why Embrace 2" class="w-[90%] md:w-full md:mb-12 mb-4" src="/assets/Emotional-C76VLMBu.svg" />
            <div class="text-start">
              <h2 class="text-base md:text-lg italic font-semibold mb-4 md:mb-6 text-center text-[var(--blue-fig)]">
      ...
      >
        ...
        <h2 class="text-xl md:text-3xl font-bold text-center">Internship &amp; Career Readiness Programs</h2>
        <div class="flex flex-col md:flex-row gap-6 md:gap-4 mt-6">
          <div
            class="bg-white z-[1] border-2 border-gray-200 rounded-4xl p-6 flex flex-col items-center mx-auto w-[90%] md:w-[50%] h-auto"
          >
            <img loading="lazy" decoding="async" width="531" height="320"
              alt="Why Embrace 2"
              class="w-[90%] md:w-full md:mb-12 mb-4"
      ...
      >
        ...
        <h2 class="text-xl md:text-3xl font-bold text-center">How it works?</h2>
