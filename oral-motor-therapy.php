...
<link href="https://embracelives.com/oral-motor-therapy" rel="canonical"/>
<!-- Open Graph -->
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://embracelives.com/oral-motor-therapy#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
...
<ul>
  <li><a href="/locations/oral-motor-therapy-in-delhi" class="text-[#234394] font-semibold">Oral Motor Delay Treatment in Delhi</a></li>
  <li><a href="/locations/oral-motor-therapy-in-gurgaon" class="text-[#234394] font-semibold">Oral Motor Delay Treatment in Gurgaon</a></li>
...
<div class="faq-item">
  <button type="button" class="faq-btn" aria-expanded="false">
    <span class="faq-q">Does tongue tie need to be released?</span>
    <svg class="faq-icon" viewBox="0 0 24 24" fill="none" stroke="#234394" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 5v14M5 12h14"/></svg>
  </button>
  <div class="faq-panel" hidden><p>Sometimes, but not always, and the decision is medical rather than ours alone. We assess function, then work with your paediatrician or ENT if a release is being considered.</p></div>
</div>
<div class="faq-item">
  <button type="button" class="faq-btn" aria-expanded="false">
    <span class="faq-q">How long before we see a change?</span>
    <svg class="faq-icon" viewBox="0 0 24 24" fill="none" stroke="#234394" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 5v14M5 12h14"/></svg>
  </button>
  <div class="faq-panel" hidden><p>Families often notice mealtime changes within a few weeks when exercises are done consistently. Speech clarity typically takes longer, because it depends on more than muscle strength.</p></div>
</div>
<div class="faq-item">
  <button type="button" class="faq-btn" aria-expanded="false">
    <span class="faq-q">What age can therapy start?</span>
    <svg class="faq-icon" viewBox="0 0 24 24" fill="none" stroke="#234394" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 5v14M5 12h14"/></svg>
  </button>
  <div class="faq-panel" hidden><p>Feeding and oral motor support can begin in infancy where there are difficulties. There is no minimum age for a feeding assessment if your child is struggling.</p></div>
</div>
</div>
