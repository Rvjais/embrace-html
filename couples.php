...
<html lang="en-IN">
  <head>
    ...
    <meta content="Couples Therapy &amp; Relationship Counselling in | eMbrace" property="og:title" />
    <meta
      content="Evidence-based couples therapy — communication issues, conflict resolution, pre-marital counselling &amp; relationship support. Expert therapists in Delhi."
    ...
    <meta content="Couples Therapy &amp; Relationship Counselling in | eMbrace" name="twitter:title" />
    <meta
      content="Evidence-based couples therapy — communication issues, conflict resolution, pre-marital counselling &amp; relationship support. Expert therapists in Delhi."
...
<title>Couples Therapy &amp; Relationship Counselling in | eMbrace</title>
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    },
    {
      ...
      "name": "Couples Therapy & Relationship Counselling in | eMbrace",
      "isPartOf": {
        "@id": "https://embracelives.com/#website"
      },
      "about": {
    ...
    <div id="root">
      ...
      >
        ...
        <div class="flex flex-col items-center justify-center gap-4">
          <h2 class="md:text-3xl text-lg font-bold text-center 2xl:text-5xl">What We Offer for Couples</h2>
        </div>
