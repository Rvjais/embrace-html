...
<html lang="en-IN">
  <head>
    ...
    <meta content="Leadership wellbeing and executive coaching in Delhi. Support for leaders facing unique pressures and responsibilities." name="description" />
    <meta content="index, follow" name="robots" />
    <link href="https://embracelives.com/leadership-wellbeing.php" rel="canonical" />
    <meta content="website" property="og:type" />
    <meta content="https://embracelives.com/leadership-wellbeing.html" property="og:url" />
    <meta content="Leadership Wellbeing Programs | eMbrace" property="og:title" />
    <meta content="Leadership wellbeing and executive coaching in Delhi. Support for leaders facing unique pressures and responsibilities." property="og:description" />
    ...
    <meta content="Leadership Wellbeing Programs | eMbrace" name="twitter:title" />
    <meta content="Leadership wellbeing and executive coaching in Delhi. Support for leaders facing unique pressures and responsibilities." name="twitter:description" />
    <meta content="https://embracelives.com/og-image.png" name="twitter:image" />
    <title>Leadership Wellbeing Programs | eMbrace</title>
    ...
    <div id="root">
      ...
      <div class="px-6 md:px-16 py-12 md:py-20 bg-gradient-to-b from-[#E7F7FF] to-white relative overflow-hidden flex items-center justify-center border-b border-[#E0E6F0]">
        ...
        <div class="w-full max-w-7xl mx-auto text-center">
          <span class="inline-block px-5 py-1.5 text-xs font-bold rounded-full hero-tag mb-5 tracking-wider uppercase shadow-sm">Leadership & Training</span>
          <h1 class="text-3xl md:text-5xl font-extrabold text-[#234394] leading-tight mb-4">Leadership Wellbeing Programs</h1>
          <p class="text-base md:text-lg text-gray-600 max-w-3xl mx-auto italic">Supporting those who lead our organisations.</p>
      ...
      <div class="py-3 px-6 md:px-16 border-b border-gray-100 text-xs md:text-sm text-gray-500 breadcrumbs">
        <div class="max-w-7xl mx-auto flex items-center gap-2">
          ...
          <span>/</span>
          <span class="text-gray-800 font-medium">Leadership Wellbeing</span>
        </div>
      </div>
...
<div class="w-full md:w-80 flex-shrink-0 bg-[#F9FBFF] border border-[#E0E6F0] rounded-3xl p-6 hidden md:block max-h-[85vh] overflow-y-auto sticky top-6 shadow-sm">
  ...
  <div class="mb-6">
    ...
    <ul class="space-y-1 ml-2">
      <li><a class="block px-3 py-1.5 text-xs rounded-xl transition-all duration-200 bg-[#234394] text-white font-semibold" href="/leadership-wellbeing">Leadership Wellbeing</a></li>
  ...
  <details class="group">
    ...
    <div class="mt-4 pt-3 border-t border-gray-200 max-h-[60vh] overflow-y-auto">
      ...
      <div class="mb-4">
        ...
        <ul class="space-y-1 ml-1">
          <li><a class="block py-1 text-xs text-[#234394] font-bold" href="/leadership-wellbeing">Leadership Wellbeing</a></li>
          ...
          <div class="flex-grow max-w-4xl article-content">
            <h2 class="text-2xl md:text-3xl font-bold mb-4 text-[#1e293b]">Leadership Wellbeing</h2>
            <p class="text-lg text-gray-700 leading-relaxed font-light mb-8">Supporting those who lead our organisations.</p>
...
<ul class="space-y-4 mb-8 key-points-list">
        <li class="flex items-start gap-3">
          ...
          <span class="text-sm md:text-base text-gray-700"><strong>Unique Pressures:</strong> Leaders face unique stressors including isolation, responsibility for others, decision fatigue, and constant visibility.</span>
        </li>
        <li class="flex items-start gap-3">
          <img alt="Bullet" class="w-4 h-4 flex-shrink-0 mt-1" src="/assets/Diamond-dGu0kMrR.svg" />
          <span class="text-sm md:text-base text-gray-700"><strong>Role Modelling:</strong> Leaders who prioritise their own wellbeing set a powerful example and create permission for others to do the same.</span>
        </li>
        <li class="flex items-start gap-3">
          <img alt="Bullet" class="w-4 h-4 flex-shrink-0 mt-1" src="/assets/Diamond-dGu0kMrR.svg" />
          <span class="text-sm md:text-base text-gray-700"><strong>Emotional Intelligence:</strong> Self-awareness, empathy, and relationship management are crucial skills for effective and sustainable leadership.</span>
        </li>
        <li class="flex items-start gap-3">
          <img alt="Bullet" class="w-4 h-4 flex-shrink-0 mt-1" src="/assets/Diamond-dGu0kMrR.svg" />
          <span class="text-sm md:text-base text-gray-700"><strong>Support for Leaders:</strong> Executive coaching, peer support groups, and confidential counselling help leaders manage their own wellbeing.</span>
        </li>
            </ul>
            <div class="pathway-card my-8">
              <h3 class="text-lg md:text-xl font-bold text-[#1e293b] mb-3 relative">Leadership Wellbeing at eMbrace</h3>
              <p class="text-sm md:text-base text-gray-600 leading-relaxed mb-0 relative">We provide executive coaching, leadership wellbeing programs, and confidential support services for organisational leaders.</p>
            </div>
        ...
        <div class="faq-item">
          <button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
            <span class="font-semibold text-base md:text-lg text-[#234394] group-hover:text-purple-600 transition-colors">How is executive coaching different from therapy?</span>
          ...
          <div class="transition-all duration-300 max-h-0 opacity-0 overflow-hidden">
            <p class="text-sm md:text-base text-gray-600 mt-2 pb-2 leading-relaxed">
              Coaching focuses on professional goals and performance, while therapy addresses mental health concerns.
            </p>
          </div>
        </div>
        <div class="faq-item">
          <button class="w-full text-left flex justify-between items-center focus:outline-none faq-btn">
            <span class="font-semibold text-base md:text-lg text-[#234394] group-hover:text-purple-600 transition-colors">What are signs of leader burnout?</span>
            <svg class="faq-icon" viewBox="0 0 24 24" fill="none" stroke="#234394" stroke-width="2" stroke-linecap="round"><path d="M12 5v14M5 12h14"/></svg>
          </button>
          <div class="transition-all duration-300 max-h-0 opacity-0 overflow-hidden">
            <p class="text-sm md:text-base text-gray-600 mt-2 pb-2 leading-relaxed">
              Irritability, withdrawal from team, reduced decision quality, cynicism, and physical symptoms like insomnia or headaches.
            </p>
          </div>
        </div>
        </div>
