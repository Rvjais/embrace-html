...
<html lang="en-IN">
  <head>
    ...
    <meta content="Pragmatic language disorder affects social communication — using language appropriately in social contexts. Speech therapy at eMbrace. From eMbrace, Delhi NCR." name="description" />
    <meta content="index, follow" name="robots" />
    <link href="https://embracelives.com/speech-therapy/pragmatic-language-disorder" rel="canonical" />
    <meta content="website" property="og:type" />
    <meta content="https://embracelives.com/speech-therapy/pragmatic-language-disorder" property="og:url" />
    <meta content="Pragmatic Language Disorder | eMbrace Child Psychology Delhi" property="og:title" />
    <meta content="Pragmatic language disorder affects social communication — using language appropriately in social contexts. Speech therapy at eMbrace. From eMbrace, Delhi NCR." property="og:description" />
    ...
    <meta content="Pragmatic Language Disorder | eMbrace Child Psychology Delhi" name="twitter:title" />
    <meta content="Pragmatic language disorder affects social communication — using language appropriately in social contexts. Speech therapy at eMbrace. From eMbrace, Delhi NCR." name="twitter:description" />
    <meta content="https://embracelives.com/og-image.png" name="twitter:image" />
    <title>Pragmatic Language Disorder | eMbrace Child Psychology Delhi</title>
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://embracelives.com/speech-therapy/pragmatic-language-disorder#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
        ...
        },
        {
          "@type": "ListItem",
          "position": 3,
          "name": "Pragmatic Language Disorder"
        }
      ]
    },
    {
      "@type": "MedicalWebPage",
      "@id": "https://embracelives.com/speech-therapy/pragmatic-language-disorder#webpage",
      "url": "https://embracelives.com/speech-therapy/pragmatic-language-disorder",
      "name": "Pragmatic Language Disorder | eMbrace Child Psychology Delhi",
      "isPartOf": {
        "@id": "https://embracelives.com/#website"
      },
      "about": {
      ...
      "inLanguage": "en-IN",
      "description": "Pragmatic language disorder affects social communication — using language appropriately in social contexts. Speech therapy at eMbrace. From eMbrace, Delhi NCR.",
      "breadcrumb": {
        "@id": "https://embracelives.com/speech-therapy/pragmatic-language-disorder#breadcrumb"
      }
    },
    {
      "@type": "FAQPage",
      "@id": "https://embracelives.com/speech-therapy/pragmatic-language-disorder#faq",
      "url": "https://embracelives.com/speech-therapy/pragmatic-language-disorder",
      "name": "Pragmatic Language Disorder | eMbrace Child Psychology Delhi — Frequently Asked Questions",
      "isPartOf": {
        "@id": "https://embracelives.com/speech-therapy/pragmatic-language-disorder#webpage"
      },
      "inLanguage": "en-IN",
...
<div class="w-full md:w-80 flex-shrink-0 bg-[#F9FBFF] border border-[#E0E6F0] rounded-3xl p-6 hidden md:block max-h-[85vh] overflow-y-auto sticky top-6 shadow-sm">
  ...
  <div class="mb-6">
    ...
    <ul class="space-y-1 ml-2">
      ...
      <li><a class="block px-3 py-1.5 text-xs rounded-xl transition-all duration-200 bg-[#234394] text-white font-semibold" href="/speech-therapy/pragmatic-language-disorder.php">Pragmatic Language Disorder</a></li>
    ...
    <div class="mt-4 pt-3 border-t border-gray-200 max-h-[60vh] overflow-y-auto">
      ...
      <div class="mb-4">
        ...
        <ul class="space-y-1 ml-1">
          ...
          <li><a class="block py-1 text-xs text-[#234394] font-bold" href="/speech-therapy/pragmatic-language-disorder.php">Pragmatic Language Disorder</a></li>
...
<section class="emb-nearby" aria-labelledby="emb-nearby-title">
  <h2 class="emb-nearby__title" id="emb-nearby-title">Speech Therapy across Delhi NCR</h2>
  <p class="emb-nearby__sub">We offer speech and language therapy at eMbrace centres throughout Delhi and the wider NCR. Choose the location closest to you.</p>
