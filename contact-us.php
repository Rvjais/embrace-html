...
<html lang="en-IN">
  <head>
    ...
    <meta content="Contact Us | A Guide from eMbrace Psychologists | eMbrace" property="og:title" />
    <meta
      content="Contact eMbrace — call, WhatsApp or email us for therapy inquiries. Reach our team at +91 9971576800 or info@embracelives.com. We respond within 24 hours."
    ...
    <meta content="Contact Us | A Guide from eMbrace Psychologists | eMbrace" name="twitter:title" />
    <meta
      content="Contact eMbrace — call, WhatsApp or email us for therapy inquiries. Reach our team at +91 9971576800 or info@embracelives.com. We respond within 24 hours."
...
<title>Contact Us | A Guide from eMbrace Psychologists | eMbrace</title>
  ...
  <script type="application/ld+json">
  {
    ...
    "@graph": [
      ...
      {
        "@type": "ContactPage",
        "@id": "https://embracelives.com/contact-us#webpage",
        "url": "https://embracelives.com/contact-us",
        "name": "Contact Us | A Guide from eMbrace Psychologists | eMbrace",
        "isPartOf": {
          "@id": "https://embracelives.com/#website"
        },
        "about": {
  ...
  <body>
    <div id="root">
      ...
      >
        <h2 class="text-xl md:text-3xl font-bold text-center">Support Categories</h2>
      ...
      >
        ...
        <h2 class="md:text-2xl text-xl text-center font-bold">Frequently Asked Questions (FAQs)</h2>
        ...
        <h2 class="md:text-2xl text-xl font-bold 2xl:mt-20 mt-6 text-center">Need Immediate Healthcare Support?</h2>
        ...
        >
          <h2 class="text-[var(--text-gray)] italic text-lg font-semibold mx-auto">Helplines</h2>
      ...
      >
        ...
        ></div>
        <h2 class="md:text-2xl text-xl font-bold text-center">Stay Connected on Social Media</h2>
