...
<html lang="en-IN">
  <head>
    ...
    <meta content="Teacher wellbeing programs in Delhi. Counselling, stress management, and support for educator mental health. Speak to our team about a programme built for you." name="description" />
    <meta content="index, follow" name="robots" />
    <link href="https://embracelives.com/schools-hub/teacher-wellbeing-programs" rel="canonical" />
    <meta content="website" property="og:type" />
    <meta content="https://embracelives.com/schools-hub/teacher-wellbeing-programs" property="og:url" />
    <meta content="Teacher Wellbeing Programs | eMbrace Child Psychology Delhi" property="og:title" />
    <meta content="Teacher wellbeing programs in Delhi. Counselling, stress management, and support for educator mental health. Speak to our team about a programme built for you." property="og:description" />
    ...
    <meta content="Teacher Wellbeing Programs | eMbrace Child Psychology Delhi" name="twitter:title" />
    <meta content="Teacher wellbeing programs in Delhi. Counselling, stress management, and support for educator mental health. Speak to our team about a programme built for you." name="twitter:description" />
    <meta content="https://embracelives.com/og-image.png" name="twitter:image" />
    <title>Teacher Wellbeing Programs | eMbrace Child Psychology Delhi</title>
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://embracelives.com/schools-hub/teacher-wellbeing-programs#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
    ...
    {
      "@type": "MedicalWebPage",
      "@id": "https://embracelives.com/schools-hub/teacher-wellbeing-programs#webpage",
      "url": "https://embracelives.com/schools-hub/teacher-wellbeing-programs",
      "name": "Teacher Wellbeing Programs | eMbrace Child Psychology Delhi",
      "isPartOf": {
        "@id": "https://embracelives.com/#website"
      },
      "about": {
      ...
      "inLanguage": "en-IN",
      "description": "Teacher wellbeing programs in Delhi. Counselling, stress management, and support for educator mental health. Speak to our team about a programme built for you.",
      "breadcrumb": {
        "@id": "https://embracelives.com/schools-hub/teacher-wellbeing-programs#breadcrumb"
      }
    },
    {
      "@type": "FAQPage",
      "@id": "https://embracelives.com/schools-hub/teacher-wellbeing-programs#faq",
      "url": "https://embracelives.com/schools-hub/teacher-wellbeing-programs",
      "name": "Teacher Wellbeing Programs | eMbrace Child Psychology Delhi — Frequently Asked Questions",
      "isPartOf": {
        "@id": "https://embracelives.com/schools-hub/teacher-wellbeing-programs#webpage"
      },
      "inLanguage": "en-IN",
      "mainEntity": [
        {
          "@type": "Question",
          "name": "How can schools support teacher wellbeing?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Reduce administrative burden, provide planning time, create supportive culture, offer counselling access, and recognise teacher efforts."
          }
        },
        {
          "@type": "Question",
          "name": "What are signs of teacher burnout?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Exhaustion, cynicism, reduced effectiveness, irritability, withdrawal, and physical symptoms like headaches and sleep problems."
          }
        }
      ]
    }
...
<div class="w-full md:w-80 flex-shrink-0 bg-[#F9FBFF] border border-[#E0E6F0] rounded-3xl p-6 hidden md:block max-h-[85vh] overflow-y-auto sticky top-6 shadow-sm">
  ...
  <div class="mb-6">
    ...
    <ul class="space-y-1 ml-2">
      ...
      <li><a class="block px-3 py-1.5 text-xs rounded-xl transition-all duration-200 bg-[#234394] text-white font-semibold" href="/schools-hub/teacher-wellbeing-programs.php">Teacher Wellbeing Programs</a></li>
    ...
    <div class="mt-4 pt-3 border-t border-gray-200 max-h-[60vh] overflow-y-auto">
      ...
      <div class="mb-4">
        ...
        <ul class="space-y-1 ml-1">
          ...
          <li><a class="block py-1 text-xs text-[#234394] font-bold" href="/schools-hub/teacher-wellbeing-programs.php">Teacher Wellbeing Programs</a></li>
