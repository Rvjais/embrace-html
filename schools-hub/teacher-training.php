...
<html lang="en-IN">
  <head>
    ...
    <meta content="Teacher training programs in Delhi. Mental health literacy, inclusive practices, behaviour management, and teacher wellbeing. Talk to us about a programme." name="description" />
    <meta content="index, follow" name="robots" />
    <link href="https://embracelives.com/schools-hub/teacher-training" rel="canonical" />
    <meta content="website" property="og:type" />
    <meta content="https://embracelives.com/schools-hub/teacher-training" property="og:url" />
    <meta content="Teacher Training Programs | eMbrace Child Psychology Delhi" property="og:title" />
    <meta content="Teacher training programs in Delhi. Mental health literacy, inclusive practices, behaviour management, and teacher wellbeing. Talk to us about a programme." property="og:description" />
    ...
    <meta content="Teacher Training Programs | eMbrace Child Psychology Delhi" name="twitter:title" />
    <meta content="Teacher training programs in Delhi. Mental health literacy, inclusive practices, behaviour management, and teacher wellbeing. Talk to us about a programme." name="twitter:description" />
    <meta content="https://embracelives.com/og-image.png" name="twitter:image" />
    <title>Teacher Training Programs | eMbrace Child Psychology Delhi</title>
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://embracelives.com/schools-hub/teacher-training#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
    ...
    {
      "@type": "MedicalWebPage",
      "@id": "https://embracelives.com/schools-hub/teacher-training#webpage",
      "url": "https://embracelives.com/schools-hub/teacher-training",
      "name": "Teacher Training Programs | eMbrace Child Psychology Delhi",
      "isPartOf": {
        "@id": "https://embracelives.com/#website"
      },
      "about": {
      ...
      "inLanguage": "en-IN",
      "description": "Teacher training programs in Delhi. Mental health literacy, inclusive practices, behaviour management, and teacher wellbeing. Talk to us about a programme.",
      "breadcrumb": {
        "@id": "https://embracelives.com/schools-hub/teacher-training#breadcrumb"
      }
    },
    {
      "@type": "FAQPage",
      "@id": "https://embracelives.com/schools-hub/teacher-training#faq",
      "url": "https://embracelives.com/schools-hub/teacher-training",
      "name": "Teacher Training Programs | eMbrace Child Psychology Delhi — Frequently Asked Questions",
      "isPartOf": {
        "@id": "https://embracelives.com/schools-hub/teacher-training#webpage"
      },
      "inLanguage": "en-IN",
      "mainEntity": [
        {
          "@type": "Question",
          "name": "How long are your teacher training programs?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "We offer flexible formats from half-day workshops to year-long professional development programs."
          }
        },
        {
          "@type": "Question",
          "name": "What topics do you cover in teacher training?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Mental health awareness, inclusive practices, ADHD/autism/LD support, behaviour management, and teacher wellbeing."
          }
        }
      ]
    }
...
<div class="w-full md:w-80 flex-shrink-0 bg-[#F9FBFF] border border-[#E0E6F0] rounded-3xl p-6 hidden md:block max-h-[85vh] overflow-y-auto sticky top-6 shadow-sm">
  ...
  <div class="mb-6">
    ...
    <ul class="space-y-1 ml-2">
      <li><a class="block px-3 py-1.5 text-xs rounded-xl transition-all duration-200 bg-[#234394] text-white font-semibold" href="/schools-hub/teacher-training.php">Teacher Training</a></li>
  ...
  <details class="group">
    ...
    <div class="mt-4 pt-3 border-t border-gray-200 max-h-[60vh] overflow-y-auto">
      ...
      <div class="mb-4">
        ...
        <ul class="space-y-1 ml-1">
          <li><a class="block py-1 text-xs text-[#234394] font-bold" href="/schools-hub/teacher-training.php">Teacher Training</a></li>
