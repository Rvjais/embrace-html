...
<html lang="en-IN">
  <head>
    ...
    <meta content="Inclusive education consulting in Delhi. Help your school transition to inclusive practices with expert guidance. Talk to us about a programme for your team." name="description" />
    <meta content="index, follow" name="robots" />
    <link href="https://embracelives.com/schools-hub/inclusive-education-consulting" rel="canonical" />
    <meta content="website" property="og:type" />
    <meta content="https://embracelives.com/schools-hub/inclusive-education-consulting" property="og:url" />
    <meta content="Inclusive Education Consulting | eMbrace Psychologists Delhi" property="og:title" />
    <meta content="Inclusive education consulting in Delhi. Help your school transition to inclusive practices with expert guidance. Talk to us about a programme for your team." property="og:description" />
    ...
    <meta content="Inclusive Education Consulting | eMbrace Psychologists Delhi" name="twitter:title" />
    <meta content="Inclusive education consulting in Delhi. Help your school transition to inclusive practices with expert guidance. Talk to us about a programme for your team." name="twitter:description" />
    <meta content="https://embracelives.com/og-image.png" name="twitter:image" />
    <title>Inclusive Education Consulting | eMbrace Psychologists Delhi</title>
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://embracelives.com/schools-hub/inclusive-education-consulting#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
        ...
        },
        {
          "@type": "ListItem",
          "position": 3,
          "name": "Inclusive Education Consulting"
        }
      ]
    },
    {
      "@type": "MedicalWebPage",
      "@id": "https://embracelives.com/schools-hub/inclusive-education-consulting#webpage",
      "url": "https://embracelives.com/schools-hub/inclusive-education-consulting",
      "name": "Inclusive Education Consulting | eMbrace Psychologists Delhi",
      "isPartOf": {
        "@id": "https://embracelives.com/#website"
      },
      "about": {
      ...
      "inLanguage": "en-IN",
      "description": "Inclusive education consulting in Delhi. Help your school transition to inclusive practices with expert guidance. Talk to us about a programme for your team.",
      "breadcrumb": {
        "@id": "https://embracelives.com/schools-hub/inclusive-education-consulting#breadcrumb"
      }
    },
    {
      "@type": "FAQPage",
      "@id": "https://embracelives.com/schools-hub/inclusive-education-consulting#faq",
      "url": "https://embracelives.com/schools-hub/inclusive-education-consulting",
      "name": "Inclusive Education Consulting | eMbrace Psychologists Delhi — Frequently Asked Questions",
      "isPartOf": {
        "@id": "https://embracelives.com/schools-hub/inclusive-education-consulting#webpage"
      },
      "inLanguage": "en-IN",
      "mainEntity": [
        {
          "@type": "Question",
          "name": "What is the first step in making my school more inclusive?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Conduct an inclusive education audit to identify current strengths and gaps in policy, practice, and culture."
          }
        },
        {
          "@type": "Question",
          "name": "How long does it take to become an inclusive school?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Inclusion is a journey — visible improvements within 6-12 months, with full transformation taking 2-3 years."
          }
        }
      ]
    }
...
<div class="w-full md:w-80 flex-shrink-0 bg-[#F9FBFF] border border-[#E0E6F0] rounded-3xl p-6 hidden md:block max-h-[85vh] overflow-y-auto sticky top-6 shadow-sm">
  ...
  <div class="mb-6">
    ...
    <ul class="space-y-1 ml-2">
      <li><a class="block px-3 py-1.5 text-xs rounded-xl transition-all duration-200 bg-[#234394] text-white font-semibold" href="/schools-hub/inclusive-education-consulting.php">Inclusive Education Consulting</a></li>
  ...
  <details class="group">
    ...
    <div class="mt-4 pt-3 border-t border-gray-200 max-h-[60vh] overflow-y-auto">
      ...
      <div class="mb-4">
        ...
        <ul class="space-y-1 ml-1">
          <li><a class="block py-1 text-xs text-[#234394] font-bold" href="/schools-hub/inclusive-education-consulting.php">Inclusive Education Consulting</a></li>
