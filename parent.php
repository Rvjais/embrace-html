...
<html lang="en-IN">
  <head>
    ...
    <meta
      content="Expert parenting advice for raising children with ADHD, autism &amp; learning differences. Build stronger parent-child relationships with eMbrace. Free intake call."
      name="description"
    />
    ...
    <meta content="Parenting Tips &amp; Guidance | eMbrace Child Psychology Delhi" property="og:title" />
    <meta
      content="Expert parenting advice for raising children with ADHD, autism &amp; learning differences. Build stronger parent-child relationships with eMbrace. Free intake call."
    ...
    <meta
      content="Parenting Tips &amp; Guidance | eMbrace Child Psychology Delhi"
      name="twitter:title"
    />
    <meta
      content="Expert parenting advice for raising children with ADHD, autism &amp; learning differences. Build stronger parent-child relationships with eMbrace. Free intake call."
...
<title>Parenting Tips &amp; Guidance | eMbrace Child Psychology Delhi</title>
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    },
    {
      ...
      "name": "Parenting Tips & Guidance | eMbrace Child Psychology Delhi",
      "isPartOf": {
        "@id": "https://embracelives.com/#website"
      },
      "about": {
      ...
      "inLanguage": "en-IN",
      "description": "Expert parenting advice for raising children with ADHD, autism & learning differences. Build stronger parent-child relationships with eMbrace. Free intake call."
    }
  ]
}
</script>
    ...
    <div id="root">
          ...
          >
            ...
            <ul class="w-full flex flex-col gap-2 transition-all duration-300 opacity-0 max-h-0 overflow-hidden">
              <div class="bg-[#93CFEF36] shadow-sm/20 w-full rounded-xl flex flex-col items-center p-4">
                <h2 class="text-center font-medium mb-4 text-[var(--text-gray)] w-[90%]">
      ...
      >
        ...
        <div class="container mx-auto">
          <h2 class="text-2xl md:text-3xl font-bold 2xl:text-5xl text-center md:w-full w-[80%] mx-auto">
            How It Works
          </h2>
          <p
      ...
      >
        <div class="container mx-auto">
          <div class="flex flex-col items-center justify-center w-full">
            <h2 class="text-center text-2xl md:text-2xl lg:text-3xl font-bold">Trusted by Parents</h2>
            <p
      ...
      >
        ...
        <h2 class="text-xl md:text-3xl font-bold text-center">Our Spaces</h2>
