...
<html lang="en-IN">
  <head>
    ...
    <meta content="Peer relationship problems — difficulty making friends, social exclusion &amp; conflict. Social skills therapy at eMbrace. From our clinical team across Delhi NCR." name="description" />
    <meta content="index, follow" name="robots" />
    <link href="https://embracelives.com/child-psychology/peer-relationship-problems" rel="canonical" />
    <meta content="website" property="og:type" />
    <meta content="https://embracelives.com/child-psychology/peer-relationship-problems" property="og:url" />
    <meta content="Peer Relationship Problems in Children | eMbrace Delhi NCR" property="og:title" />
    <meta content="Peer relationship problems — difficulty making friends, social exclusion &amp; conflict. Social skills therapy at eMbrace. From our clinical team across Delhi NCR." property="og:description" />
    ...
    <meta content="Peer Relationship Problems in Children | eMbrace Delhi NCR" name="twitter:title" />
    <meta content="Peer relationship problems — difficulty making friends, social exclusion &amp; conflict. Social skills therapy at eMbrace. From our clinical team across Delhi NCR." name="twitter:description" />
    <meta content="https://embracelives.com/og-image.png" name="twitter:image" />
    <title>Peer Relationship Problems in Children | eMbrace Delhi NCR</title>
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://embracelives.com/child-psychology/peer-relationship-problems#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
    ...
    {
      "@type": "MedicalWebPage",
      "@id": "https://embracelives.com/child-psychology/peer-relationship-problems#webpage",
      "url": "https://embracelives.com/child-psychology/peer-relationship-problems",
      "name": "Peer Relationship Problems in Children | eMbrace Delhi NCR",
      "isPartOf": {
        "@id": "https://embracelives.com/#website"
      },
      "about": {
      ...
      "inLanguage": "en-IN",
      "description": "Peer relationship problems — difficulty making friends, social exclusion & conflict. Social skills therapy at eMbrace. From our clinical team across Delhi NCR.",
      "breadcrumb": {
        "@id": "https://embracelives.com/child-psychology/peer-relationship-problems#breadcrumb"
      }
    },
    {
      "@type": "FAQPage",
      "@id": "https://embracelives.com/child-psychology/peer-relationship-problems#faq",
      "url": "https://embracelives.com/child-psychology/peer-relationship-problems",
      "name": "Peer Relationship Problems in Children | eMbrace Delhi NCR — Frequently Asked Questions",
      "isPartOf": {
        "@id": "https://embracelives.com/child-psychology/peer-relationship-problems#webpage"
      },
      "inLanguage": "en-IN",
...
<div class="w-full md:w-80 flex-shrink-0 bg-[#F9FBFF] border border-[#E0E6F0] rounded-3xl p-6 hidden md:block max-h-[85vh] overflow-y-auto sticky top-6 shadow-sm">
  ...
  <div class="mb-6">
    ...
    <ul class="space-y-1 ml-2">
      <li><a class="block px-3 py-1.5 text-xs rounded-xl transition-all duration-200 bg-[#234394] text-white font-semibold" href="/child-psychology/peer-relationship-problems.php">Peer Relationship Problems</a></li>
  ...
  <details class="group">
    ...
    <div class="mt-4 pt-3 border-t border-gray-200 max-h-[60vh] overflow-y-auto">
      ...
      <div class="mb-4">
        ...
        <ul class="space-y-1 ml-1">
          <li><a class="block py-1 text-xs text-[#234394] font-bold" href="/child-psychology/peer-relationship-problems.php">Peer Relationship Problems</a></li>
