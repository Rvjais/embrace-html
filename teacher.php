...
<script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    {
      "@type": "WebPage",
      "@id": "https://embracelives.com/teacher#webpage",
      "url": "https://embracelives.com/teacher",
      "name": "Teacher Support & Neurodiversity Training | eMbrace Lives",
      "isPartOf": {
        "@id": "https://embracelives.com/#website"
      },
      "about": {
  ...
  <body>
    <div id="root">
      ...
      >
        ...
        <div class="2xl:px-12 flex md:flex-row w-full flex-col items-stretch h-auto gap-8 justify-center mt-8">
          ...
          <div
            class="bg-[#FFFFFF] pb-6 md:pb-4 2xl:py-10 2xl:gap-8 md:w-[90%] w-full lg:w-[40%] items-center gap-2 px-4 pt-6 z-10 rounded-3xl md:rounded-2xl flex flex-col shadow-[0px_7px_12px_0px_#00000070] md:shadow-[0_2px_6.2px_rgba(0,0,0,0.1)] md:gap-4"
          >
            <img loading="lazy" decoding="async" width="673" height="400"
              alt="undefined illustration"
              class="md:w-full 2xl:h-[70%] w-[90%] mb-2 md:mt-4"
          ...
          <div
            class="bg-[#FFFFFF] pb-6 md:pb-4 2xl:py-10 2xl:gap-8 md:w-[90%] w-full lg:w-[40%] items-center gap-2 px-4 pt-6 z-10 rounded-3xl md:rounded-2xl flex flex-col shadow-[0px_7px_12px_0px_#00000070] md:shadow-[0_2px_6.2px_rgba(0,0,0,0.1)] md:gap-4"
          >
            <img loading="lazy" decoding="async" width="670" height="400"
              alt="undefined illustration"
              class="md:w-full 2xl:h-[70%] w-[90%] mb-2 md:mt-4"
      ...
      >
        ...
        <h2 class="md:text-3xl text-xl mb-8 font-bold md:text-start text-center">Embrace for</h2>
        <div
      ...
      >
        ...
        <h2 class="mt-12 font-semibold italic text-[var(--text-gray)] text-lg text-center">
